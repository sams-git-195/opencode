export const dict = {
  ...
  "command.settings.agents": "تحرير الوكلاء",
  "titlebar.agentRefresh.label": "تغيّرت ملفات الوكلاء. أعد تحميل الإعدادات",
  "settings.section.project": "المشروع",
  "settings.agents.empty": "لم يتم العثور على ملفات وكلاء. أضف ملف markdown داخل ‎.opencode/agent لإنشاء وكيل.",
  "settings.agents.scope.project": "المشروع",
  "settings.agents.scope.global": "عام",
  "settings.agents.tag.disabled": "معطّل",
  "settings.agents.section.permissions": "الأذونات",
  "settings.agents.section.prompt": "الموجّه",
  "settings.agents.field.inherit": "توريث",
  "settings.agents.field.description.title": "الوصف",
  "settings.agents.field.description.description": "يخبر الوكلاء الآخرين متى يستخدمون هذا الوكيل",
  "settings.agents.field.description.placeholder": "ما الذي يجب أن يقوم به هذا الوكيل؟",
  "settings.agents.field.mode.title": "الوضع",
  "settings.agents.field.mode.description": "ما إذا كان الوكيل يعمل كوكيل أساسي أو وكيل فرعي أو كليهما",
  "settings.agents.field.model.title": "النموذج",
  "settings.agents.field.model.description": "النموذج الذي يعمل به هذا الوكيل",
  "settings.agents.field.temperature.title": "درجة الحرارة",
  "settings.agents.field.temperature.description": "درجة حرارة أخذ العينات، بين 0 و1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "عتبة أخذ العينات النووية، بين 0 و1",
  "settings.agents.field.steps.title": "الخطوات",
  "settings.agents.field.steps.description": "الحد الأقصى لتكرارات الأدوات قبل فرض رد نصي فقط",
  "settings.agents.field.hidden.title": "مخفي",
  "settings.agents.field.hidden.description": "إخفاء هذا الوكيل الفرعي من قائمة الإشارات",
  "settings.agents.field.disable.title": "معطّل",
  "settings.agents.field.disable.description": "إزالة هذا الوكيل من قائمة الوكلاء",
  "settings.agents.field.prompt.placeholder": "موجّه النظام لهذا الوكيل",
  "settings.agents.mode.all": "الكل",
  "settings.agents.mode.primary": "أساسي",
  "settings.agents.mode.subagent": "وكيل فرعي",
  "settings.agents.rule.inherit": "توريث",
  "settings.agents.rule.allow": "السماح",
  "settings.agents.rule.ask": "طلب الإذن",
  "settings.agents.rule.deny": "الرفض",
  "settings.agents.extraKeys": "قابل للتحرير في الملف فقط: {{keys}}",
  "settings.agents.toast.saved.title": "تم حفظ {{agent}}",
  "settings.agents.toast.saved.description": "تُطبّق التغييرات على الجلسات الجديدة.",
  "settings.agents.rule.patterns": "حسب النمط",
  "settings.agents.patterns.hint": "يُطبَّق آخر نمط مطابق.",
  "settings.agents.patterns.add": "إضافة نمط",
  "settings.agents.patterns.placeholder": "النمط، مثل git push",
  "settings.agents.patterns.remove": "إزالة النمط",
  "settings.agents.patterns.moveUp": "نقل النمط لأعلى",
  "settings.agents.patterns.moveDown": "نقل النمط لأسفل",
  "settings.agents.action.new": "وكيل جديد",
  "settings.agents.action.create": "إنشاء",
  "settings.agents.action.deleteConfirm": "تأكيد الحذف",
  "settings.agents.new.name": "الاسم",
  "settings.agents.new.name.hint": "حروف وأرقام ونقاط وشرطات. استخدم / للتداخل، مثل team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "الموقع",
  "settings.agents.new.scope.hint": "وكلاء المشروع موجودون في ‎.opencode/agent ويُشاركون مع المستودع",
  "settings.agents.toast.created.title": "تم إنشاء {{agent}}",
  "settings.agents.toast.deleted.title": "تم حذف {{agent}}",
}
