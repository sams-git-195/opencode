export const dict = {
  ...
  "command.settings.agents": "ایجنٹس میں ترمیم کریں",
  "titlebar.agentRefresh.label": "ایجنٹ فائلیں تبدیل ہو گئی ہیں۔ ترتیبات دوبارہ لوڈ کریں",
  "settings.section.project": "پروجیکٹ",
  "settings.agents.empty":
    "کوئی ایجنٹ فائل نہیں ملی۔ ایجنٹ بنانے کے لیے ‎.opencode/agent میں ایک markdown فائل شامل کریں۔",
  "settings.agents.scope.project": "پروجیکٹ",
  "settings.agents.scope.global": "عالمی",
  "settings.agents.tag.disabled": "غیر فعال",
  "settings.agents.section.permissions": "اجازتیں",
  "settings.agents.section.prompt": "پرامپٹ",
  "settings.agents.field.inherit": "وراثت میں لیں",
  "settings.agents.field.description.title": "تفصیل",
  "settings.agents.field.description.description": "دوسرے ایجنٹس کو بتاتا ہے کہ اس ایجنٹ کو کب استعمال کرنا ہے",
  "settings.agents.field.description.placeholder": "اس ایجنٹ کو کیا کرنا چاہیے؟",
  "settings.agents.field.mode.title": "موڈ",
  "settings.agents.field.mode.description": "آیا ایجنٹ بنیادی ایجنٹ، ذیلی ایجنٹ یا دونوں کے طور پر چلے گا",
  "settings.agents.field.model.title": "ماڈل",
  "settings.agents.field.model.description": "وہ ماڈل جس پر یہ ایجنٹ چلتا ہے",
  "settings.agents.field.temperature.title": "ٹمپریچر",
  "settings.agents.field.temperature.description": "سیمپلنگ ٹمپریچر، 0 اور 1 کے درمیان",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "نیوکلیس سیمپلنگ کی حد، 0 اور 1 کے درمیان",
  "settings.agents.field.steps.title": "مراحل",
  "settings.agents.field.steps.description": "صرف متن والا جواب نافذ کرنے سے پہلے ٹولز کی زیادہ سے زیادہ تکرار",
  "settings.agents.field.hidden.title": "پوشیدہ",
  "settings.agents.field.hidden.description": "اس ذیلی ایجنٹ کو مینشن مینو سے چھپائیں",
  "settings.agents.field.disable.title": "غیر فعال",
  "settings.agents.field.disable.description": "اس ایجنٹ کو ایجنٹ فہرست سے ہٹا دیں",
  "settings.agents.field.prompt.placeholder": "اس ایجنٹ کے لیے سسٹم پرامپٹ",
  "settings.agents.mode.all": "تمام",
  "settings.agents.mode.primary": "بنیادی",
  "settings.agents.mode.subagent": "ذیلی ایجنٹ",
  "settings.agents.rule.inherit": "وراثت میں لیں",
  "settings.agents.rule.allow": "اجازت دیں۔",
  "settings.agents.rule.ask": "پوچھیں",
  "settings.agents.rule.deny": "انکار کریں",
  "settings.agents.extraKeys": "صرف فائل میں قابل ترمیم: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} محفوظ ہو گیا",
  "settings.agents.toast.saved.description": "تبدیلیاں نئے سیشنز پر لاگو ہوتی ہیں۔",
  "settings.agents.rule.patterns": "پیٹرن کے مطابق",
  "settings.agents.patterns.hint": "آخری مماثل پیٹرن نافذ ہوتا ہے۔",
  "settings.agents.patterns.add": "پیٹرن شامل کریں",
  "settings.agents.patterns.placeholder": "پیٹرن، مثلاً git push",
  "settings.agents.patterns.remove": "پیٹرن ہٹائیں",
  "settings.agents.patterns.moveUp": "پیٹرن اوپر لے جائیں",
  "settings.agents.patterns.moveDown": "پیٹرن نیچے لے جائیں",
  "settings.agents.action.new": "نیا ایجنٹ",
  "settings.agents.action.create": "بنائیں",
  "settings.agents.action.deleteConfirm": "حذف کی تصدیق کریں",
  "settings.agents.new.name": "نام",
  "settings.agents.new.name.hint": "حروف، اعداد، نقطے اور ڈیش۔ نیسٹ کرنے کے لیے / استعمال کریں، مثلاً team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "مقام",
  "settings.agents.new.scope.hint": "پروجیکٹ ایجنٹس ‎.opencode/agent میں ہوتے ہیں اور ریپازٹری کے ساتھ شیئر ہوتے ہیں",
  "settings.agents.toast.created.title": "{{agent}} بنا دیا گیا",
  "settings.agents.toast.deleted.title": "{{agent}} حذف کر دیا گیا",
}
