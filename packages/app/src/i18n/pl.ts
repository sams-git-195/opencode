export const dict = {
  ...
  "command.settings.agents": "Edytuj agentów",
  "titlebar.agentRefresh.label": "Pliki agentów uległy zmianie. Wczytaj konfigurację ponownie",
  "settings.section.project": "Projekt",
  "settings.agents.empty":
    "Nie znaleziono plików agentów. Dodaj plik markdown w katalogu .opencode/agent, aby utworzyć agenta.",
  "settings.agents.scope.project": "Projekt",
  "settings.agents.scope.global": "Globalne",
  "settings.agents.tag.disabled": "Wyłączony",
  "settings.agents.section.permissions": "Uprawnienia",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Dziedzicz",
  "settings.agents.field.description.title": "Opis",
  "settings.agents.field.description.description": "Informuje innych agentów, kiedy użyć tego agenta",
  "settings.agents.field.description.placeholder": "Co ma robić ten agent?",
  "settings.agents.field.mode.title": "Tryb",
  "settings.agents.field.mode.description": "Czy agent działa jako agent główny, jako podagent, czy jako oba",
  "settings.agents.field.model.title": "Model",
  "settings.agents.field.model.description": "Model, na którym działa ten agent",
  "settings.agents.field.temperature.title": "Temperatura",
  "settings.agents.field.temperature.description": "Temperatura próbkowania z zakresu od 0 do 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Próg próbkowania nucleus z zakresu od 0 do 1",
  "settings.agents.field.steps.title": "Kroki",
  "settings.agents.field.steps.description":
    "Maksymalna liczba iteracji narzędzi przed wymuszeniem odpowiedzi tekstowej",
  "settings.agents.field.hidden.title": "Ukryty",
  "settings.agents.field.hidden.description": "Ukryj tego podagenta w menu wzmianek",
  "settings.agents.field.disable.title": "Wyłączony",
  "settings.agents.field.disable.description": "Usuń tego agenta z listy agentów",
  "settings.agents.field.prompt.placeholder": "Prompt systemowy dla tego agenta",
  "settings.agents.mode.all": "Wszystkie",
  "settings.agents.mode.primary": "Główny",
  "settings.agents.mode.subagent": "Podagent",
  "settings.agents.rule.inherit": "Dziedzicz",
  "settings.agents.rule.allow": "Zezwól",
  "settings.agents.rule.ask": "Pytaj",
  "settings.agents.rule.deny": "Odmów",
  "settings.agents.extraKeys": "Edytowalne tylko w pliku: {{keys}}",
  "settings.agents.toast.saved.title": "Zapisano {{agent}}",
  "settings.agents.toast.saved.description": "Zmiany dotyczą nowych sesji.",
  "settings.agents.rule.patterns": "Według wzorca",
  "settings.agents.patterns.hint": "Wygrywa ostatni pasujący wzorzec.",
  "settings.agents.patterns.add": "Dodaj wzorzec",
  "settings.agents.patterns.placeholder": "Wzorzec, na przykład git push",
  "settings.agents.patterns.remove": "Usuń wzorzec",
  "settings.agents.patterns.moveUp": "Przenieś wzorzec w górę",
  "settings.agents.patterns.moveDown": "Przenieś wzorzec w dół",
  "settings.agents.action.new": "Nowy agent",
  "settings.agents.action.create": "Utwórz",
  "settings.agents.action.deleteConfirm": "Potwierdź usunięcie",
  "settings.agents.new.name": "Nazwa",
  "settings.agents.new.name.hint":
    "Litery, cyfry, kropki i myślniki. Użyj / do zagnieżdżania, na przykład team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Lokalizacja",
  "settings.agents.new.scope.hint": "Agenci projektu znajdują się w .opencode/agent i są współdzieleni z repozytorium",
  "settings.agents.toast.created.title": "Utworzono {{agent}}",
  "settings.agents.toast.deleted.title": "Usunięto {{agent}}",
}
