export const dict = {
  ...
  "command.settings.agents": "エージェントを編集",
  "titlebar.agentRefresh.label": "エージェントファイルが変更されました。設定を再読み込みします",
  "settings.section.project": "プロジェクト",
  "settings.agents.empty":
    "エージェントファイルが見つかりません。.opencode/agent に Markdown ファイルを追加すると作成できます。",
  "settings.agents.scope.project": "プロジェクト",
  "settings.agents.scope.global": "グローバル",
  "settings.agents.tag.disabled": "無効",
  "settings.agents.section.permissions": "権限",
  "settings.agents.section.prompt": "プロンプト",
  "settings.agents.field.inherit": "継承",
  "settings.agents.field.description.title": "説明",
  "settings.agents.field.description.description": "このエージェントをいつ使うかを他のエージェントに伝えます",
  "settings.agents.field.description.placeholder": "このエージェントの役割は何ですか？",
  "settings.agents.field.mode.title": "モード",
  "settings.agents.field.mode.description":
    "エージェントをプライマリエージェント、サブエージェント、またはその両方として実行するか",
  "settings.agents.field.model.title": "モデル",
  "settings.agents.field.model.description": "このエージェントが使用するモデル",
  "settings.agents.field.temperature.title": "Temperature",
  "settings.agents.field.temperature.description": "0 から 1 までのサンプリング温度",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "0 から 1 までの Nucleus サンプリングのしきい値",
  "settings.agents.field.steps.title": "ステップ数",
  "settings.agents.field.steps.description": "テキストのみの応答を強制するまでのツール実行の最大回数",
  "settings.agents.field.hidden.title": "非表示",
  "settings.agents.field.hidden.description": "このサブエージェントをメンションメニューに表示しません",
  "settings.agents.field.disable.title": "無効",
  "settings.agents.field.disable.description": "このエージェントをエージェント一覧から削除します",
  "settings.agents.field.prompt.placeholder": "このエージェントのシステムプロンプト",
  "settings.agents.mode.all": "すべて",
  "settings.agents.mode.primary": "プライマリ",
  "settings.agents.mode.subagent": "サブエージェント",
  "settings.agents.rule.inherit": "継承",
  "settings.agents.rule.allow": "許可",
  "settings.agents.rule.ask": "確認",
  "settings.agents.rule.deny": "拒否",
  "settings.agents.extraKeys": "ファイル内でのみ編集可能: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} を保存しました",
  "settings.agents.toast.saved.description": "変更は新しいセッションに適用されます。",
  "settings.agents.rule.patterns": "パターンごと",
  "settings.agents.patterns.hint": "最後に一致したパターンが優先されます。",
  "settings.agents.patterns.add": "パターンを追加",
  "settings.agents.patterns.placeholder": "パターン (例: git push)",
  "settings.agents.patterns.remove": "パターンを削除",
  "settings.agents.patterns.moveUp": "パターンを上へ移動",
  "settings.agents.patterns.moveDown": "パターンを下へ移動",
  "settings.agents.action.new": "新しいエージェント",
  "settings.agents.action.create": "作成",
  "settings.agents.action.deleteConfirm": "削除を確認",
  "settings.agents.new.name": "名前",
  "settings.agents.new.name.hint": "英数字、ピリオド、ハイフンが使えます。/ で入れ子にできます (例: team/reviewer)",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "保存場所",
  "settings.agents.new.scope.hint": "プロジェクトのエージェントは .opencode/agent に置かれ、リポジトリで共有されます",
  "settings.agents.toast.created.title": "{{agent}} を作成しました",
  "settings.agents.toast.deleted.title": "{{agent}} を削除しました",
}
