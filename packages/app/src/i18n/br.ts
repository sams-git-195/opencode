export const dict = {
  ...
  "titlebar.agentRefresh.label": "Os arquivos de agente mudaram. Recarregar a configuração",
  "settings.section.project": "Projeto",
  "settings.agents.empty":
    "Nenhum arquivo de agente encontrado. Adicione um arquivo markdown em .opencode/agent para criar um.",
  "settings.agents.scope.project": "Projeto",
  "settings.agents.scope.global": "Global",
  "settings.agents.tag.disabled": "Desativado",
  "settings.agents.section.permissions": "Permissões",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Herdar",
  "settings.agents.field.description.title": "Descrição",
  "settings.agents.field.description.description": "Informa a outros agentes quando usar este agente",
  "settings.agents.field.description.placeholder": "O que este agente deve fazer?",
  "settings.agents.field.mode.title": "Modo",
  "settings.agents.field.mode.description": "Se o agente é executado como agente principal, como subagente ou ambos",
  "settings.agents.field.model.title": "Modelo",
  "settings.agents.field.model.description": "Modelo em que este agente é executado",
  "settings.agents.field.temperature.title": "Temperatura",
  "settings.agents.field.temperature.description": "Temperatura de amostragem, entre 0 e 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Limite de amostragem por núcleo, entre 0 e 1",
  "settings.agents.field.steps.title": "Etapas",
  "settings.agents.field.steps.description":
    "Número máximo de iterações de ferramentas antes de forçar uma resposta somente de texto",
  "settings.agents.field.hidden.title": "Oculto",
  "settings.agents.field.hidden.description": "Ocultar este subagente do menu de menções",
  "settings.agents.field.disable.title": "Desativado",
  "settings.agents.field.disable.description": "Remover este agente da lista de agentes",
  "settings.agents.field.prompt.placeholder": "Prompt de sistema para este agente",
  "settings.agents.mode.all": "Todos",
  "settings.agents.mode.primary": "Principal",
  "settings.agents.mode.subagent": "Subagente",
  "settings.agents.rule.inherit": "Herdar",
  "settings.agents.rule.allow": "Permitir",
  "settings.agents.rule.ask": "Perguntar",
  "settings.agents.rule.deny": "Negar",
  "settings.agents.extraKeys": "Editável apenas no arquivo: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} salvo",
  "settings.agents.toast.saved.description": "As alterações se aplicam a novas sessões.",
  "settings.agents.rule.patterns": "Por padrão",
  "settings.agents.patterns.hint": "O último padrão correspondente prevalece.",
  "settings.agents.patterns.add": "Adicionar padrão",
  "settings.agents.patterns.placeholder": "Padrão, por exemplo git push",
  "settings.agents.patterns.remove": "Remover padrão",
  "settings.agents.patterns.moveUp": "Mover padrão para cima",
  "settings.agents.patterns.moveDown": "Mover padrão para baixo",
  "settings.agents.action.new": "Novo agente",
  "settings.agents.action.create": "Criar",
  "settings.agents.action.deleteConfirm": "Confirmar exclusão",
  "settings.agents.new.name": "Nome",
  "settings.agents.new.name.hint": "Letras, números, pontos e hifens. Use / para aninhar, por exemplo team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Local",
  "settings.agents.new.scope.hint":
    "Agentes de projeto ficam em .opencode/agent e são compartilhados com o repositório",
  "settings.agents.toast.created.title": "{{agent}} criado",
  "settings.agents.toast.deleted.title": "{{agent}} excluído",
}
