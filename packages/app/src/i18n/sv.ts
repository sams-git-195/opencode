export const dict = {
  ...
  "command.settings.agents": "Redigera agenter",
  "titlebar.agentRefresh.label": "Agentfilerna har ändrats. Läs in konfigurationen på nytt",
  "settings.section.project": "Projekt",
  "settings.agents.empty":
    "Inga agentfiler hittades. Lägg till en markdown-fil under .opencode/agent för att skapa en.",
  "settings.agents.scope.project": "Projekt",
  "settings.agents.scope.global": "Global",
  "settings.agents.tag.disabled": "Inaktiverad",
  "settings.agents.section.permissions": "Behörigheter",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Ärv",
  "settings.agents.field.description.title": "Beskrivning",
  "settings.agents.field.description.description": "Talar om för andra agenter när den här agenten ska användas",
  "settings.agents.field.description.placeholder": "Vad ska den här agenten göra?",
  "settings.agents.field.mode.title": "Läge",
  "settings.agents.field.mode.description": "Om agenten körs som primär agent, som underagent eller båda",
  "settings.agents.field.model.title": "Modell",
  "settings.agents.field.model.description": "Modell som den här agenten körs på",
  "settings.agents.field.temperature.title": "Temperatur",
  "settings.agents.field.temperature.description": "Samplingstemperatur mellan 0 och 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Tröskelvärde för nucleus-sampling mellan 0 och 1",
  "settings.agents.field.steps.title": "Steg",
  "settings.agents.field.steps.description":
    "Högsta antal verktygsiterationer innan ett svar med enbart text framtvingas",
  "settings.agents.field.hidden.title": "Dold",
  "settings.agents.field.hidden.description": "Dölj den här underagenten i omnämnandemenyn",
  "settings.agents.field.disable.title": "Inaktiverad",
  "settings.agents.field.disable.description": "Ta bort den här agenten från agentlistan",
  "settings.agents.field.prompt.placeholder": "Systemprompt för den här agenten",
  "settings.agents.mode.all": "Alla",
  "settings.agents.mode.primary": "Primär",
  "settings.agents.mode.subagent": "Underagent",
  "settings.agents.rule.inherit": "Ärv",
  "settings.agents.rule.allow": "Tillåt",
  "settings.agents.rule.ask": "Fråga",
  "settings.agents.rule.deny": "Neka",
  "settings.agents.extraKeys": "Kan bara redigeras i filen: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} sparad",
  "settings.agents.toast.saved.description": "Ändringarna gäller nya sessioner.",
  "settings.agents.rule.patterns": "Per mönster",
  "settings.agents.patterns.hint": "Det sista mönstret som matchar vinner.",
  "settings.agents.patterns.add": "Lägg till mönster",
  "settings.agents.patterns.placeholder": "Mönster, till exempel git push",
  "settings.agents.patterns.remove": "Ta bort mönster",
  "settings.agents.patterns.moveUp": "Flytta mönstret uppåt",
  "settings.agents.patterns.moveDown": "Flytta mönstret nedåt",
  "settings.agents.action.new": "Ny agent",
  "settings.agents.action.create": "Skapa",
  "settings.agents.action.deleteConfirm": "Bekräfta borttagning",
  "settings.agents.new.name": "Namn",
  "settings.agents.new.name.hint":
    "Bokstäver, siffror, punkter och bindestreck. Använd / för att nästla, till exempel team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Plats",
  "settings.agents.new.scope.hint": "Projektagenter ligger i .opencode/agent och delas med utvecklingskatalogen",
  "settings.agents.toast.created.title": "{{agent}} skapad",
  "settings.agents.toast.deleted.title": "{{agent}} borttagen",
}
