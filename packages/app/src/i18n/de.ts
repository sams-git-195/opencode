...
export const dict = {
  ...
  "command.settings.agents": "Agenten bearbeiten",
  "titlebar.agentRefresh.label": "Agentendateien wurden geändert. Konfiguration neu laden",
  "settings.section.project": "Projekt",
  "settings.agents.empty":
    "Keine Agentendateien gefunden. Legen Sie eine Markdown-Datei unter .opencode/agent an, um einen Agenten zu erstellen.",
  "settings.agents.scope.project": "Projekt",
  "settings.agents.scope.global": "Global",
  "settings.agents.tag.disabled": "Deaktiviert",
  "settings.agents.section.permissions": "Berechtigungen",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Übernehmen",
  "settings.agents.field.description.title": "Beschreibung",
  "settings.agents.field.description.description": "Teilt anderen Agenten mit, wann dieser Agent zu verwenden ist",
  "settings.agents.field.description.placeholder": "Was soll dieser Agent tun?",
  "settings.agents.field.mode.title": "Modus",
  "settings.agents.field.mode.description":
    "Ob der Agent als primärer Agent, als Subagent oder als beides ausgeführt wird",
  "settings.agents.field.model.title": "Modell",
  "settings.agents.field.model.description": "Modell, mit dem dieser Agent ausgeführt wird",
  "settings.agents.field.temperature.title": "Temperatur",
  "settings.agents.field.temperature.description": "Sampling-Temperatur zwischen 0 und 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Schwellenwert für Nucleus-Sampling zwischen 0 und 1",
  "settings.agents.field.steps.title": "Schritte",
  "settings.agents.field.steps.description":
    "Maximale Anzahl an Tool-Durchläufen, bevor eine reine Textantwort erzwungen wird",
  "settings.agents.field.hidden.title": "Ausgeblendet",
  "settings.agents.field.hidden.description": "Diesen Subagenten im Erwähnungsmenü ausblenden",
  "settings.agents.field.disable.title": "Deaktiviert",
  "settings.agents.field.disable.description": "Diesen Agenten aus der Agentenliste entfernen",
  "settings.agents.field.prompt.placeholder": "Systemprompt für diesen Agenten",
  "settings.agents.mode.all": "Alle",
  "settings.agents.mode.primary": "Primär",
  "settings.agents.mode.subagent": "Subagent",
  "settings.agents.rule.inherit": "Übernehmen",
  "settings.agents.rule.allow": "Erlauben",
  "settings.agents.rule.ask": "Fragen",
  "settings.agents.rule.deny": "Verweigern",
  "settings.agents.extraKeys": "Nur in der Datei bearbeitbar: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} gespeichert",
  "settings.agents.toast.saved.description": "Änderungen gelten für neue Sitzungen.",
  "settings.agents.rule.patterns": "Pro Muster",
  "settings.agents.patterns.hint": "Das zuletzt passende Muster gewinnt.",
  "settings.agents.patterns.add": "Muster hinzufügen",
  "settings.agents.patterns.placeholder": "Muster, z. B. git push",
  "settings.agents.patterns.remove": "Muster entfernen",
  "settings.agents.patterns.moveUp": "Muster nach oben verschieben",
  "settings.agents.patterns.moveDown": "Muster nach unten verschieben",
  "settings.agents.action.new": "Neuer Agent",
  "settings.agents.action.create": "Erstellen",
  "settings.agents.action.deleteConfirm": "Löschen bestätigen",
  "settings.agents.new.name": "Name",
  "settings.agents.new.name.hint":
    "Buchstaben, Ziffern, Punkte und Bindestriche. Mit / verschachteln, z. B. team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Speicherort",
  "settings.agents.new.scope.hint": "Projektagenten liegen in .opencode/agent und werden mit dem Repository geteilt",
  "settings.agents.toast.created.title": "{{agent}} erstellt",
  "settings.agents.toast.deleted.title": "{{agent}} gelöscht",
