export const dict = {
  ...
  "command.settings.agents": "Editar agentes",
  "titlebar.agentRefresh.label": "Los archivos de agente han cambiado. Recargar la configuración",
  "settings.section.project": "Proyecto",
  "settings.agents.empty":
    "No se han encontrado archivos de agente. Añade un archivo markdown en .opencode/agent para crear uno.",
  "settings.agents.scope.project": "Proyecto",
  "settings.agents.scope.global": "Global",
  "settings.agents.tag.disabled": "Desactivado",
  "settings.agents.section.permissions": "Permisos",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Heredar",
  "settings.agents.field.description.title": "Descripción",
  "settings.agents.field.description.description": "Indica a otros agentes cuándo usar este agente",
  "settings.agents.field.description.placeholder": "¿Qué debe hacer este agente?",
  "settings.agents.field.mode.title": "Modo",
  "settings.agents.field.mode.description": "Si el agente se ejecuta como agente principal, como subagente o ambos",
  "settings.agents.field.model.title": "Modelo",
  "settings.agents.field.model.description": "Modelo con el que se ejecuta este agente",
  "settings.agents.field.temperature.title": "Temperatura",
  "settings.agents.field.temperature.description": "Temperatura de muestreo, entre 0 y 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Umbral de muestreo por núcleo, entre 0 y 1",
  "settings.agents.field.steps.title": "Pasos",
  "settings.agents.field.steps.description":
    "Número máximo de iteraciones de herramientas antes de forzar una respuesta solo de texto",
  "settings.agents.field.hidden.title": "Oculto",
  "settings.agents.field.hidden.description": "Ocultar este subagente del menú de menciones",
  "settings.agents.field.disable.title": "Desactivado",
  "settings.agents.field.disable.description": "Quitar este agente de la lista de agentes",
  "settings.agents.field.prompt.placeholder": "Prompt del sistema para este agente",
  "settings.agents.mode.all": "Todos",
  "settings.agents.mode.primary": "Principal",
  "settings.agents.mode.subagent": "Subagente",
  "settings.agents.rule.inherit": "Heredar",
  "settings.agents.rule.allow": "Permitir",
  "settings.agents.rule.ask": "Preguntar",
  "settings.agents.rule.deny": "Denegar",
  "settings.agents.extraKeys": "Solo editable en el archivo: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} guardado",
  "settings.agents.toast.saved.description": "Los cambios se aplican a las sesiones nuevas.",
  "settings.agents.rule.patterns": "Por patrón",
  "settings.agents.patterns.hint": "Gana el último patrón coincidente.",
  "settings.agents.patterns.add": "Añadir patrón",
  "settings.agents.patterns.placeholder": "Patrón, por ejemplo git push",
  "settings.agents.patterns.remove": "Quitar patrón",
  "settings.agents.patterns.moveUp": "Mover el patrón hacia arriba",
  "settings.agents.patterns.moveDown": "Mover el patrón hacia abajo",
  "settings.agents.action.new": "Nuevo agente",
  "settings.agents.action.create": "Crear",
  "settings.agents.action.deleteConfirm": "Confirmar eliminación",
  "settings.agents.new.name": "Nombre",
  "settings.agents.new.name.hint": "Letras, números, puntos y guiones. Usa / para anidar, por ejemplo team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Ubicación",
  "settings.agents.new.scope.hint":
    "Los agentes de proyecto están en .opencode/agent y se comparten con el repositorio",
  "settings.agents.toast.created.title": "{{agent}} creado",
  "settings.agents.toast.deleted.title": "{{agent}} eliminado",
}
