export const dict = {
  ...
  "command.settings.agents": "Agenten bewerken",
  "titlebar.agentRefresh.label": "Agentbestanden zijn gewijzigd. Configuratie opnieuw laden",
  "settings.section.project": "Project",
  "settings.agents.empty":
    "Geen agentbestanden gevonden. Voeg een markdown-bestand toe onder .opencode/agent om er een te maken.",
  "settings.agents.scope.project": "Project",
  "settings.agents.scope.global": "Globaal",
  "settings.agents.tag.disabled": "Uitgeschakeld",
  "settings.agents.section.permissions": "Machtigingen",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Overnemen",
  "settings.agents.field.description.title": "Beschrijving",
  "settings.agents.field.description.description": "Vertelt andere agenten wanneer ze deze agent moeten gebruiken",
  "settings.agents.field.description.placeholder": "Wat moet deze agent doen?",
  "settings.agents.field.mode.title": "Modus",
  "settings.agents.field.mode.description": "Of de agent draait als primaire agent, als subagent of als beide",
  "settings.agents.field.model.title": "Model",
  "settings.agents.field.model.description": "Model waarop deze agent draait",
  "settings.agents.field.temperature.title": "Temperatuur",
  "settings.agents.field.temperature.description": "Sampling-temperatuur, tussen 0 en 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Drempel voor nucleus-sampling, tussen 0 en 1",
  "settings.agents.field.steps.title": "Stappen",
  "settings.agents.field.steps.description":
    "Maximaal aantal tool-iteraties voordat een antwoord met alleen tekst wordt afgedwongen",
  "settings.agents.field.hidden.title": "Verborgen",
  "settings.agents.field.hidden.description": "Deze subagent verbergen in het vermeldingsmenu",
  "settings.agents.field.disable.title": "Uitgeschakeld",
  "settings.agents.field.disable.description": "Deze agent uit de agentenlijst verwijderen",
  "settings.agents.field.prompt.placeholder": "Systeemprompt voor deze agent",
  "settings.agents.mode.all": "Alle",
  "settings.agents.mode.primary": "Primair",
  "settings.agents.mode.subagent": "Subagent",
  "settings.agents.rule.inherit": "Overnemen",
  "settings.agents.rule.allow": "Toestaan",
  "settings.agents.rule.ask": "Vragen",
  "settings.agents.rule.deny": "Weigeren",
  "settings.agents.extraKeys": "Alleen te bewerken in het bestand: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} opgeslagen",
  "settings.agents.toast.saved.description": "Wijzigingen gelden voor nieuwe sessies.",
  "settings.agents.rule.patterns": "Per patroon",
  "settings.agents.patterns.hint": "Het laatst overeenkomende patroon wint.",
  "settings.agents.patterns.add": "Patroon toevoegen",
  "settings.agents.patterns.placeholder": "Patroon, bijvoorbeeld git push",
  "settings.agents.patterns.remove": "Patroon verwijderen",
  "settings.agents.patterns.moveUp": "Patroon omhoog verplaatsen",
  "settings.agents.patterns.moveDown": "Patroon omlaag verplaatsen",
  "settings.agents.action.new": "Nieuwe agent",
  "settings.agents.action.create": "Maken",
  "settings.agents.action.deleteConfirm": "Verwijderen bevestigen",
  "settings.agents.new.name": "Naam",
  "settings.agents.new.name.hint":
    "Letters, cijfers, punten en streepjes. Gebruik / om te nesten, bijvoorbeeld team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Locatie",
  "settings.agents.new.scope.hint": "Projectagenten staan in .opencode/agent en worden met de repository gedeeld",
  "settings.agents.toast.created.title": "{{agent}} gemaakt",
  "settings.agents.toast.deleted.title": "{{agent}} verwijderd",
}
