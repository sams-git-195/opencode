export const dict = {
  ...
  "command.settings.agents": "Modifier les agents",
  "titlebar.agentRefresh.label": "Les fichiers d'agent ont changé. Recharger la configuration",
  "settings.section.project": "Projet",
  "settings.agents.empty":
    "Aucun fichier d'agent trouvé. Ajoutez un fichier markdown dans .opencode/agent pour en créer un.",
  "settings.agents.scope.project": "Projet",
  "settings.agents.scope.global": "Global",
  "settings.agents.tag.disabled": "Désactivé",
  "settings.agents.section.permissions": "Permissions",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Hériter",
  "settings.agents.field.description.title": "Description",
  "settings.agents.field.description.description": "Indique aux autres agents quand utiliser cet agent",
  "settings.agents.field.description.placeholder": "Que doit faire cet agent ?",
  "settings.agents.field.mode.title": "Mode",
  "settings.agents.field.mode.description": "Si l'agent s'exécute comme agent principal, comme sous-agent, ou les deux",
  "settings.agents.field.model.title": "Modèle",
  "settings.agents.field.model.description": "Modèle utilisé par cet agent",
  "settings.agents.field.temperature.title": "Température",
  "settings.agents.field.temperature.description": "Température d'échantillonnage, entre 0 et 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Seuil d'échantillonnage nucleus, entre 0 et 1",
  "settings.agents.field.steps.title": "Étapes",
  "settings.agents.field.steps.description":
    "Nombre maximal d'itérations d'outils avant de forcer une réponse en texte seul",
  "settings.agents.field.hidden.title": "Masqué",
  "settings.agents.field.hidden.description": "Masquer ce sous-agent du menu de mention",
  "settings.agents.field.disable.title": "Désactivé",
  "settings.agents.field.disable.description": "Retirer cet agent de la liste des agents",
  "settings.agents.field.prompt.placeholder": "Prompt système de cet agent",
  "settings.agents.mode.all": "Tous",
  "settings.agents.mode.primary": "Principal",
  "settings.agents.mode.subagent": "Sous-agent",
  "settings.agents.rule.inherit": "Hériter",
  "settings.agents.rule.allow": "Autoriser",
  "settings.agents.rule.ask": "Demander",
  "settings.agents.rule.deny": "Refuser",
  "settings.agents.extraKeys": "Modifiable uniquement dans le fichier : {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} enregistré",
  "settings.agents.toast.saved.description": "Les modifications s'appliquent aux nouvelles sessions.",
  "settings.agents.rule.patterns": "Par motif",
  "settings.agents.patterns.hint": "Le dernier motif correspondant l'emporte.",
  "settings.agents.patterns.add": "Ajouter un motif",
  "settings.agents.patterns.placeholder": "Motif, par exemple git push",
  "settings.agents.patterns.remove": "Supprimer le motif",
  "settings.agents.patterns.moveUp": "Déplacer le motif vers le haut",
  "settings.agents.patterns.moveDown": "Déplacer le motif vers le bas",
  "settings.agents.action.new": "Nouvel agent",
  "settings.agents.action.create": "Créer",
  "settings.agents.action.deleteConfirm": "Confirmer la suppression",
  "settings.agents.new.name": "Nom",
  "settings.agents.new.name.hint":
    "Lettres, chiffres, points et tirets. Utilisez / pour imbriquer, par exemple team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Emplacement",
  "settings.agents.new.scope.hint":
    "Les agents de projet se trouvent dans .opencode/agent et sont partagés avec le dépôt",
  "settings.agents.toast.created.title": "{{agent}} créé",
  "settings.agents.toast.deleted.title": "{{agent}} supprimé",
}
