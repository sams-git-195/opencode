export const dict = {
  ...
  "command.settings.agents": "แก้ไขเอเจนต์",
  "titlebar.agentRefresh.label": "ไฟล์เอเจนต์มีการเปลี่ยนแปลง โหลดการตั้งค่าใหม่",
  "settings.section.project": "โปรเจกต์",
  "settings.agents.empty": "ไม่พบไฟล์เอเจนต์ เพิ่มไฟล์ markdown ใน .opencode/agent เพื่อสร้างเอเจนต์",
  "settings.agents.scope.project": "โปรเจกต์",
  "settings.agents.scope.global": "ส่วนกลาง",
  "settings.agents.tag.disabled": "ปิดใช้งาน",
  "settings.agents.section.permissions": "สิทธิ์",
  "settings.agents.section.prompt": "พรอมต์",
  "settings.agents.field.inherit": "สืบทอด",
  "settings.agents.field.description.title": "คำอธิบาย",
  "settings.agents.field.description.description": "บอกเอเจนต์อื่นว่าควรใช้เอเจนต์นี้เมื่อใด",
  "settings.agents.field.description.placeholder": "เอเจนต์นี้ควรทำอะไร",
  "settings.agents.field.mode.title": "โหมด",
  "settings.agents.field.mode.description": "เอเจนต์ทำงานเป็นเอเจนต์หลัก เอเจนต์ย่อย หรือทั้งสองอย่าง",
  "settings.agents.field.model.title": "โมเดล",
  "settings.agents.field.model.description": "โมเดลที่เอเจนต์นี้ใช้",
  "settings.agents.field.temperature.title": "อุณหภูมิ",
  "settings.agents.field.temperature.description": "อุณหภูมิการสุ่มตัวอย่าง ระหว่าง 0 ถึง 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "เกณฑ์การสุ่มตัวอย่างแบบ nucleus ระหว่าง 0 ถึง 1",
  "settings.agents.field.steps.title": "ขั้นตอน",
  "settings.agents.field.steps.description": "จำนวนรอบการเรียกใช้เครื่องมือสูงสุดก่อนบังคับให้ตอบเป็นข้อความอย่างเดียว",
  "settings.agents.field.hidden.title": "ซ่อน",
  "settings.agents.field.hidden.description": "ซ่อนเอเจนต์ย่อยนี้จากเมนูการกล่าวถึง",
  "settings.agents.field.disable.title": "ปิดใช้งาน",
  "settings.agents.field.disable.description": "นำเอเจนต์นี้ออกจากรายการเอเจนต์",
  "settings.agents.field.prompt.placeholder": "พรอมต์ระบบสำหรับเอเจนต์นี้",
  "settings.agents.mode.all": "ทั้งหมด",
  "settings.agents.mode.primary": "หลัก",
  "settings.agents.mode.subagent": "เอเจนต์ย่อย",
  "settings.agents.rule.inherit": "สืบทอด",
  "settings.agents.rule.allow": "อนุญาต",
  "settings.agents.rule.ask": "ถาม",
  "settings.agents.rule.deny": "ปฏิเสธ",
  "settings.agents.extraKeys": "แก้ไขได้ในไฟล์เท่านั้น: {{keys}}",
  "settings.agents.toast.saved.title": "บันทึก {{agent}} แล้ว",
  "settings.agents.toast.saved.description": "การเปลี่ยนแปลงจะมีผลกับเซสชันใหม่",
  "settings.agents.rule.patterns": "ตามรูปแบบ",
  "settings.agents.patterns.hint": "รูปแบบที่ตรงกันรายการสุดท้ายจะมีผล",
  "settings.agents.patterns.add": "เพิ่มรูปแบบ",
  "settings.agents.patterns.placeholder": "รูปแบบ เช่น git push",
  "settings.agents.patterns.remove": "ลบรูปแบบ",
  "settings.agents.patterns.moveUp": "เลื่อนรูปแบบขึ้น",
  "settings.agents.patterns.moveDown": "เลื่อนรูปแบบลง",
  "settings.agents.action.new": "เอเจนต์ใหม่",
  "settings.agents.action.create": "สร้าง",
  "settings.agents.action.deleteConfirm": "ยืนยันการลบ",
  "settings.agents.new.name": "ชื่อ",
  "settings.agents.new.name.hint": "ใช้ตัวอักษร ตัวเลข จุด และขีดกลาง ใช้ / เพื่อจัดกลุ่มซ้อน เช่น team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "ตำแหน่งที่เก็บ",
  "settings.agents.new.scope.hint": "เอเจนต์ของโปรเจกต์อยู่ใน .opencode/agent และแชร์ไปกับที่เก็บโค้ด",
  "settings.agents.toast.created.title": "สร้าง {{agent}} แล้ว",
  "settings.agents.toast.deleted.title": "ลบ {{agent}} แล้ว",
}
