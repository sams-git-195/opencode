export const dict = {
  ...
  "command.settings.agents": "에이전트 편집",
  "titlebar.agentRefresh.label": "에이전트 파일이 변경되었습니다. 구성 다시 불러오기",
  "settings.section.project": "프로젝트",
  "settings.agents.empty": "에이전트 파일이 없습니다. .opencode/agent 아래에 마크다운 파일을 추가해 만드세요.",
  "settings.agents.scope.project": "프로젝트",
  "settings.agents.scope.global": "전역",
  "settings.agents.tag.disabled": "사용 안 함",
  "settings.agents.section.permissions": "권한",
  "settings.agents.section.prompt": "프롬프트",
  "settings.agents.field.inherit": "상속",
  "settings.agents.field.description.title": "설명",
  "settings.agents.field.description.description": "다른 에이전트에 이 에이전트를 언제 사용할지 알려 줍니다",
  "settings.agents.field.description.placeholder": "이 에이전트는 무엇을 해야 하나요?",
  "settings.agents.field.mode.title": "모드",
  "settings.agents.field.mode.description": "에이전트를 기본 에이전트, 하위 에이전트 또는 둘 다로 실행할지 여부",
  "settings.agents.field.model.title": "모델",
  "settings.agents.field.model.description": "이 에이전트가 사용하는 모델",
  "settings.agents.field.temperature.title": "온도",
  "settings.agents.field.temperature.description": "0에서 1 사이의 샘플링 온도",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "0에서 1 사이의 뉴클리어스 샘플링 임계값",
  "settings.agents.field.steps.title": "단계",
  "settings.agents.field.steps.description": "텍스트 전용 응답을 강제하기 전 최대 도구 반복 횟수",
  "settings.agents.field.hidden.title": "숨김",
  "settings.agents.field.hidden.description": "멘션 메뉴에서 이 하위 에이전트를 숨깁니다",
  "settings.agents.field.disable.title": "사용 안 함",
  "settings.agents.field.disable.description": "에이전트 목록에서 이 에이전트를 제거합니다",
  "settings.agents.field.prompt.placeholder": "이 에이전트의 시스템 프롬프트",
  "settings.agents.mode.all": "모두",
  "settings.agents.mode.primary": "기본",
  "settings.agents.mode.subagent": "하위 에이전트",
  "settings.agents.rule.inherit": "상속",
  "settings.agents.rule.allow": "허용",
  "settings.agents.rule.ask": "묻기",
  "settings.agents.rule.deny": "거부",
  "settings.agents.extraKeys": "파일에서만 편집 가능: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} 저장됨",
  "settings.agents.toast.saved.description": "변경 사항은 새 세션에 적용됩니다.",
  "settings.agents.rule.patterns": "패턴별",
  "settings.agents.patterns.hint": "마지막으로 일치하는 패턴이 적용됩니다.",
  "settings.agents.patterns.add": "패턴 추가",
  "settings.agents.patterns.placeholder": "패턴, 예: git push",
  "settings.agents.patterns.remove": "패턴 제거",
  "settings.agents.patterns.moveUp": "패턴 위로 이동",
  "settings.agents.patterns.moveDown": "패턴 아래로 이동",
  "settings.agents.action.new": "새 에이전트",
  "settings.agents.action.create": "만들기",
  "settings.agents.action.deleteConfirm": "삭제 확인",
  "settings.agents.new.name": "이름",
  "settings.agents.new.name.hint":
    "문자, 숫자, 마침표, 하이픈을 사용합니다. / 로 중첩할 수 있습니다. 예: team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "위치",
  "settings.agents.new.scope.hint": "프로젝트 에이전트는 .opencode/agent에 있으며 리포지토리와 함께 공유됩니다",
  "settings.agents.toast.created.title": "{{agent}} 생성됨",
  "settings.agents.toast.deleted.title": "{{agent}} 삭제됨",
}
