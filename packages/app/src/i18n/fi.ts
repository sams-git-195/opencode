export const dict = {
  ...
  "command.settings.agents": "Muokkaa agentteja",
  "titlebar.agentRefresh.label": "Agenttitiedostot ovat muuttuneet. Lataa asetukset uudelleen",
  "settings.section.project": "Projekti",
  "settings.agents.empty":
    "Agenttitiedostoja ei löytynyt. Lisää markdown-tiedosto hakemistoon .opencode/agent luodaksesi agentin.",
  "settings.agents.scope.project": "Projekti",
  "settings.agents.scope.global": "Yleinen",
  "settings.agents.tag.disabled": "Poistettu käytöstä",
  "settings.agents.section.permissions": "Käyttöoikeudet",
  "settings.agents.section.prompt": "Kehote",
  "settings.agents.field.inherit": "Peri",
  "settings.agents.field.description.title": "Kuvaus",
  "settings.agents.field.description.description": "Kertoo muille agenteille, milloin tätä agenttia käytetään",
  "settings.agents.field.description.placeholder": "Mitä tämän agentin pitäisi tehdä?",
  "settings.agents.field.mode.title": "Tila",
  "settings.agents.field.mode.description": "Toimiiko agentti ensisijaisena agenttina, aliagenttina vai molempina",
  "settings.agents.field.model.title": "Malli",
  "settings.agents.field.model.description": "Malli, jolla tämä agentti toimii",
  "settings.agents.field.temperature.title": "Lämpötila",
  "settings.agents.field.temperature.description": "Otantalämpötila välillä 0–1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Nucleus-otannan kynnysarvo välillä 0–1",
  "settings.agents.field.steps.title": "Vaiheet",
  "settings.agents.field.steps.description":
    "Työkalukierrosten enimmäismäärä ennen kuin pelkkä tekstivastaus pakotetaan",
  "settings.agents.field.hidden.title": "Piilotettu",
  "settings.agents.field.hidden.description": "Piilota tämä aliagentti mainintavalikosta",
  "settings.agents.field.disable.title": "Poistettu käytöstä",
  "settings.agents.field.disable.description": "Poista tämä agentti agenttiluettelosta",
  "settings.agents.field.prompt.placeholder": "Tämän agentin järjestelmäkehote",
  "settings.agents.mode.all": "Kaikki",
  "settings.agents.mode.primary": "Ensisijainen",
  "settings.agents.mode.subagent": "Aliagentti",
  "settings.agents.rule.inherit": "Peri",
  "settings.agents.rule.allow": "Salli",
  "settings.agents.rule.ask": "Kysy",
  "settings.agents.rule.deny": "Kiellä",
  "settings.agents.extraKeys": "Muokattavissa vain tiedostossa: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} tallennettu",
  "settings.agents.toast.saved.description": "Muutokset koskevat uusia istuntoja.",
  "settings.agents.rule.patterns": "Mallikohtainen",
  "settings.agents.patterns.hint": "Viimeisin osuva malli voittaa.",
  "settings.agents.patterns.add": "Lisää malli",
  "settings.agents.patterns.placeholder": "Malli, esimerkiksi git push",
  "settings.agents.patterns.remove": "Poista malli",
  "settings.agents.patterns.moveUp": "Siirrä mallia ylöspäin",
  "settings.agents.patterns.moveDown": "Siirrä mallia alaspäin",
  "settings.agents.action.new": "Uusi agentti",
  "settings.agents.action.create": "Luo",
  "settings.agents.action.deleteConfirm": "Vahvista poisto",
  "settings.agents.new.name": "Nimi",
  "settings.agents.new.name.hint":
    "Kirjaimia, numeroita, pisteitä ja väliviivoja. Sisennä /-merkillä, esimerkiksi team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Sijainti",
  "settings.agents.new.scope.hint": "Projektiagentit sijaitsevat hakemistossa .opencode/agent ja jaetaan säilön kanssa",
  "settings.agents.toast.created.title": "{{agent}} luotu",
  "settings.agents.toast.deleted.title": "{{agent}} poistettu",
}
