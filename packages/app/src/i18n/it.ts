export const dict = {
  ...
  "command.settings.agents": "Modifica agenti",
  "titlebar.agentRefresh.label": "I file degli agenti sono cambiati. Ricarica la configurazione",
  "settings.section.project": "Progetto",
  "settings.agents.empty":
    "Nessun file di agente trovato. Aggiungi un file markdown in .opencode/agent per crearne uno.",
  "settings.agents.scope.project": "Progetto",
  "settings.agents.scope.global": "Globale",
  "settings.agents.tag.disabled": "Disattivato",
  "settings.agents.section.permissions": "Autorizzazioni",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Eredita",
  "settings.agents.field.description.title": "Descrizione",
  "settings.agents.field.description.description": "Indica agli altri agenti quando usare questo agente",
  "settings.agents.field.description.placeholder": "Che cosa deve fare questo agente?",
  "settings.agents.field.mode.title": "Modalità",
  "settings.agents.field.mode.description":
    "Se l'agente viene eseguito come agente principale, come subagente o entrambi",
  "settings.agents.field.model.title": "Modello",
  "settings.agents.field.model.description": "Modello con cui viene eseguito questo agente",
  "settings.agents.field.temperature.title": "Temperatura",
  "settings.agents.field.temperature.description": "Temperatura di campionamento, tra 0 e 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Soglia di campionamento nucleus, tra 0 e 1",
  "settings.agents.field.steps.title": "Passaggi",
  "settings.agents.field.steps.description":
    "Numero massimo di iterazioni degli strumenti prima di forzare una risposta di solo testo",
  "settings.agents.field.hidden.title": "Nascosto",
  "settings.agents.field.hidden.description": "Nascondi questo subagente dal menu delle menzioni",
  "settings.agents.field.disable.title": "Disattivato",
  "settings.agents.field.disable.description": "Rimuovi questo agente dall'elenco degli agenti",
  "settings.agents.field.prompt.placeholder": "Prompt di sistema per questo agente",
  "settings.agents.mode.all": "Tutti",
  "settings.agents.mode.primary": "Principale",
  "settings.agents.mode.subagent": "Subagente",
  "settings.agents.rule.inherit": "Eredita",
  "settings.agents.rule.allow": "Consenti",
  "settings.agents.rule.ask": "Chiedi",
  "settings.agents.rule.deny": "Nega",
  "settings.agents.extraKeys": "Modificabile solo nel file: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} salvato",
  "settings.agents.toast.saved.description": "Le modifiche si applicano alle nuove sessioni.",
  "settings.agents.rule.patterns": "Per criterio",
  "settings.agents.patterns.hint": "Vince l'ultimo criterio corrispondente.",
  "settings.agents.patterns.add": "Aggiungi criterio",
  "settings.agents.patterns.placeholder": "Criterio, ad esempio git push",
  "settings.agents.patterns.remove": "Rimuovi criterio",
  "settings.agents.patterns.moveUp": "Sposta il criterio in alto",
  "settings.agents.patterns.moveDown": "Sposta il criterio in basso",
  "settings.agents.action.new": "Nuovo agente",
  "settings.agents.action.create": "Crea",
  "settings.agents.action.deleteConfirm": "Conferma eliminazione",
  "settings.agents.new.name": "Nome",
  "settings.agents.new.name.hint": "Lettere, numeri, punti e trattini. Usa / per annidare, ad esempio team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Posizione",
  "settings.agents.new.scope.hint":
    "Gli agenti di progetto risiedono in .opencode/agent e sono condivisi con il repository",
  "settings.agents.toast.created.title": "{{agent}} creato",
  "settings.agents.toast.deleted.title": "{{agent}} eliminato",
}
