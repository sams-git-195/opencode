export const dict = {
  ...
  "command.settings.agents": "Agentləri redaktə et",
  "titlebar.agentRefresh.label": "Agent faylları dəyişdi. Konfiqurasiyanı yenidən yüklə",
  "settings.section.project": "Layihə",
  "settings.agents.empty":
    "Agent faylı tapılmadı. Agent yaratmaq üçün .opencode/agent qovluğuna markdown faylı əlavə edin.",
  "settings.agents.scope.project": "Layihə",
  "settings.agents.scope.global": "Qlobal",
  "settings.agents.tag.disabled": "Deaktiv",
  "settings.agents.section.permissions": "İcazələr",
  "settings.agents.section.prompt": "Sorğu",
  "settings.agents.field.inherit": "Miras al",
  "settings.agents.field.description.title": "Təsvir",
  "settings.agents.field.description.description": "Digər agentlərə bu agentin nə vaxt istifadə olunacağını bildirir",
  "settings.agents.field.description.placeholder": "Bu agent nə etməlidir?",
  "settings.agents.field.mode.title": "Rejim",
  "settings.agents.field.mode.description": "Agentin əsas agent, alt agent və ya hər ikisi kimi işləməsi",
  "settings.agents.field.model.title": "Model",
  "settings.agents.field.model.description": "Bu agentin işlədiyi model",
  "settings.agents.field.temperature.title": "Temperatur",
  "settings.agents.field.temperature.description": "0 ilə 1 arasında seçmə temperaturu",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "0 ilə 1 arasında nucleus seçmə həddi",
  "settings.agents.field.steps.title": "Addımlar",
  "settings.agents.field.steps.description":
    "Yalnız mətn cavabı məcbur edilməzdən əvvəl maksimum alət təkrarlarının sayı",
  "settings.agents.field.hidden.title": "Gizli",
  "settings.agents.field.hidden.description": "Bu alt agenti qeyd menyusunda gizlə",
  "settings.agents.field.disable.title": "Deaktiv",
  "settings.agents.field.disable.description": "Bu agenti agent siyahısından sil",
  "settings.agents.field.prompt.placeholder": "Bu agent üçün sistem sorğusu",
  "settings.agents.mode.all": "Hamısı",
  "settings.agents.mode.primary": "Əsas",
  "settings.agents.mode.subagent": "Alt agent",
  "settings.agents.rule.inherit": "Miras al",
  "settings.agents.rule.allow": "İcazə ver",
  "settings.agents.rule.ask": "Soruş",
  "settings.agents.rule.deny": "Rədd et",
  "settings.agents.extraKeys": "Yalnız faylda redaktə oluna bilər: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} saxlanıldı",
  "settings.agents.toast.saved.description": "Dəyişikliklər yeni sessiyalara tətbiq olunur.",
  "settings.agents.rule.patterns": "Nümunə üzrə",
  "settings.agents.patterns.hint": "Uyğun gələn sonuncu nümunə qalib gəlir.",
  "settings.agents.patterns.add": "Nümunə əlavə et",
  "settings.agents.patterns.placeholder": "Nümunə, məsələn git push",
  "settings.agents.patterns.remove": "Nümunəni sil",
  "settings.agents.patterns.moveUp": "Nümunəni yuxarı köçür",
  "settings.agents.patterns.moveDown": "Nümunəni aşağı köçür",
  "settings.agents.action.new": "Yeni agent",
  "settings.agents.action.create": "Yarat",
  "settings.agents.action.deleteConfirm": "Silməni təsdiqlə",
  "settings.agents.new.name": "Ad",
  "settings.agents.new.name.hint":
    "Hərflər, rəqəmlər, nöqtələr və tirelər. İç-içə yerləşdirmək üçün / işlədin, məsələn team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Yer",
  "settings.agents.new.scope.hint":
    "Layihə agentləri .opencode/agent qovluğunda yerləşir və repozitoriya ilə paylaşılır",
  "settings.agents.toast.created.title": "{{agent}} yaradıldı",
  "settings.agents.toast.deleted.title": "{{agent}} silindi",
}
