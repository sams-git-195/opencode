export const dict = {
  ...
  "command.settings.agents": "Uredi agente",
  "titlebar.agentRefresh.label": "Datoteke agenata su promijenjene. Ponovo učitaj konfiguraciju",
  "settings.section.project": "Projekat",
  "settings.agents.empty":
    "Nije pronađena nijedna datoteka agenta. Dodaj markdown datoteku u .opencode/agent da kreiraš agenta.",
  "settings.agents.scope.project": "Projekat",
  "settings.agents.scope.global": "Globalno",
  "settings.agents.tag.disabled": "Onemogućen",
  "settings.agents.section.permissions": "Dozvole",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Naslijedi",
  "settings.agents.field.description.title": "Opis",
  "settings.agents.field.description.description": "Govori drugim agentima kada da koriste ovog agenta",
  "settings.agents.field.description.placeholder": "Šta ovaj agent treba da radi?",
  "settings.agents.field.mode.title": "Način rada",
  "settings.agents.field.mode.description": "Da li agent radi kao primarni agent, kao podagent ili oboje",
  "settings.agents.field.model.title": "Model",
  "settings.agents.field.model.description": "Model na kojem ovaj agent radi",
  "settings.agents.field.temperature.title": "Temperatura",
  "settings.agents.field.temperature.description": "Temperatura uzorkovanja, između 0 i 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Prag nucleus uzorkovanja, između 0 i 1",
  "settings.agents.field.steps.title": "Koraci",
  "settings.agents.field.steps.description":
    "Najveći broj iteracija alata prije nego što se nametne odgovor samo u tekstu",
  "settings.agents.field.hidden.title": "Skriven",
  "settings.agents.field.hidden.description": "Sakrij ovog podagenta iz menija za spominjanje",
  "settings.agents.field.disable.title": "Onemogućen",
  "settings.agents.field.disable.description": "Ukloni ovog agenta sa liste agenata",
  "settings.agents.field.prompt.placeholder": "Sistemski prompt za ovog agenta",
  "settings.agents.mode.all": "Svi",
  "settings.agents.mode.primary": "Primarni",
  "settings.agents.mode.subagent": "Podagent",
  "settings.agents.rule.inherit": "Naslijedi",
  "settings.agents.rule.allow": "Dozvoli",
  "settings.agents.rule.ask": "Pitaj",
  "settings.agents.rule.deny": "Zabrani",
  "settings.agents.extraKeys": "Uređuje se samo u datoteci: {{keys}}",
  "settings.agents.toast.saved.title": "Sačuvano: {{agent}}",
  "settings.agents.toast.saved.description": "Promjene se primjenjuju na nove sesije.",
  "settings.agents.rule.patterns": "Po obrascu",
  "settings.agents.patterns.hint": "Pobjeđuje posljednji obrazac koji odgovara.",
  "settings.agents.patterns.add": "Dodaj obrazac",
  "settings.agents.patterns.placeholder": "Obrazac, na primjer git push",
  "settings.agents.patterns.remove": "Ukloni obrazac",
  "settings.agents.patterns.moveUp": "Pomjeri obrazac gore",
  "settings.agents.patterns.moveDown": "Pomjeri obrazac dolje",
  "settings.agents.action.new": "Novi agent",
  "settings.agents.action.create": "Kreiraj",
  "settings.agents.action.deleteConfirm": "Potvrdi brisanje",
  "settings.agents.new.name": "Naziv",
  "settings.agents.new.name.hint":
    "Slova, brojevi, tačke i crtice. Koristi / za ugnježđavanje, na primjer team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Lokacija",
  "settings.agents.new.scope.hint": "Agenti projekta nalaze se u .opencode/agent i dijele se sa repozitorijem",
  "settings.agents.toast.created.title": "Kreirano: {{agent}}",
  "settings.agents.toast.deleted.title": "Obrisano: {{agent}}",
}
