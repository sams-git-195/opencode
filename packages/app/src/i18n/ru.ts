export const dict = {
  ...
  "command.settings.agents": "Редактировать агентов",
  "titlebar.agentRefresh.label": "Файлы агентов изменились. Перезагрузить конфигурацию",
  "settings.section.project": "Проект",
  "settings.agents.empty": "Файлы агентов не найдены. Добавьте markdown-файл в .opencode/agent, чтобы создать агента.",
  "settings.agents.scope.project": "Проект",
  "settings.agents.scope.global": "Глобально",
  "settings.agents.tag.disabled": "Отключён",
  "settings.agents.section.permissions": "Разрешения",
  "settings.agents.section.prompt": "Промпт",
  "settings.agents.field.inherit": "Наследовать",
  "settings.agents.field.description.title": "Описание",
  "settings.agents.field.description.description": "Сообщает другим агентам, когда использовать этого агента",
  "settings.agents.field.description.placeholder": "Что должен делать этот агент?",
  "settings.agents.field.mode.title": "Режим",
  "settings.agents.field.mode.description": "Работает ли агент как основной агент, как субагент или как оба",
  "settings.agents.field.model.title": "Модель",
  "settings.agents.field.model.description": "Модель, на которой работает этот агент",
  "settings.agents.field.temperature.title": "Температура",
  "settings.agents.field.temperature.description": "Температура сэмплирования от 0 до 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Порог nucleus-сэмплирования от 0 до 1",
  "settings.agents.field.steps.title": "Шаги",
  "settings.agents.field.steps.description":
    "Максимальное число итераций инструментов до принудительного текстового ответа",
  "settings.agents.field.hidden.title": "Скрытый",
  "settings.agents.field.hidden.description": "Скрыть этого субагента из меню упоминаний",
  "settings.agents.field.disable.title": "Отключён",
  "settings.agents.field.disable.description": "Убрать этого агента из списка агентов",
  "settings.agents.field.prompt.placeholder": "Системный промпт для этого агента",
  "settings.agents.mode.all": "Все",
  "settings.agents.mode.primary": "Основной",
  "settings.agents.mode.subagent": "Субагент",
  "settings.agents.rule.inherit": "Наследовать",
  "settings.agents.rule.allow": "Разрешить",
  "settings.agents.rule.ask": "Спрашивать",
  "settings.agents.rule.deny": "Запретить",
  "settings.agents.extraKeys": "Редактируется только в файле: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} сохранён",
  "settings.agents.toast.saved.description": "Изменения применяются к новым сессиям.",
  "settings.agents.rule.patterns": "По шаблону",
  "settings.agents.patterns.hint": "Побеждает последний подходящий шаблон.",
  "settings.agents.patterns.add": "Добавить шаблон",
  "settings.agents.patterns.placeholder": "Шаблон, например git push",
  "settings.agents.patterns.remove": "Удалить шаблон",
  "settings.agents.patterns.moveUp": "Переместить шаблон вверх",
  "settings.agents.patterns.moveDown": "Переместить шаблон вниз",
  "settings.agents.action.new": "Новый агент",
  "settings.agents.action.create": "Создать",
  "settings.agents.action.deleteConfirm": "Подтвердить удаление",
  "settings.agents.new.name": "Имя",
  "settings.agents.new.name.hint":
    "Буквы, цифры, точки и дефисы. Используйте / для вложенности, например team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Расположение",
  "settings.agents.new.scope.hint": "Агенты проекта находятся в .opencode/agent и хранятся вместе с репозиторием",
  "settings.agents.toast.created.title": "{{agent}} создан",
  "settings.agents.toast.deleted.title": "{{agent}} удалён",
}
