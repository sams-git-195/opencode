export const dict = {
  ...
  "titlebar.agentRefresh.label": "Agentfiler er ændret. Genindlæs konfigurationen",
  "settings.section.project": "Projekt",
  "settings.agents.empty": "Ingen agentfiler fundet. Tilføj en markdown-fil under .opencode/agent for at oprette en.",
  "settings.agents.scope.project": "Projekt",
  "settings.agents.scope.global": "Global",
  "settings.agents.tag.disabled": "Deaktiveret",
  "settings.agents.section.permissions": "Tilladelser",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Nedarv",
  "settings.agents.field.description.title": "Beskrivelse",
  "settings.agents.field.description.description": "Fortæller andre agenter, hvornår denne agent skal bruges",
  "settings.agents.field.description.placeholder": "Hvad skal denne agent gøre?",
  "settings.agents.field.mode.title": "Tilstand",
  "settings.agents.field.mode.description": "Om agenten kører som primær agent, som underagent eller begge dele",
  "settings.agents.field.model.title": "Model",
  "settings.agents.field.model.description": "Model, som denne agent kører på",
  "settings.agents.field.temperature.title": "Temperatur",
  "settings.agents.field.temperature.description": "Sampling-temperatur mellem 0 og 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Tærskel for nucleus-sampling mellem 0 og 1",
  "settings.agents.field.steps.title": "Trin",
  "settings.agents.field.steps.description":
    "Maksimalt antal værktøjsgentagelser, før der tvinges et svar med kun tekst",
  "settings.agents.field.hidden.title": "Skjult",
  "settings.agents.field.hidden.description": "Skjul denne underagent i omtalemenuen",
  "settings.agents.field.disable.title": "Deaktiveret",
  "settings.agents.field.disable.description": "Fjern denne agent fra agentlisten",
  "settings.agents.field.prompt.placeholder": "Systemprompt til denne agent",
  "settings.agents.mode.all": "Alle",
  "settings.agents.mode.primary": "Primær",
  "settings.agents.mode.subagent": "Underagent",
  "settings.agents.rule.inherit": "Nedarv",
  "settings.agents.rule.allow": "Tillad",
  "settings.agents.rule.ask": "Spørg",
  "settings.agents.rule.deny": "Afvis",
  "settings.agents.extraKeys": "Kan kun redigeres i filen: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} gemt",
  "settings.agents.toast.saved.description": "Ændringer gælder for nye sessioner.",
  "settings.agents.rule.patterns": "Pr. mønster",
  "settings.agents.patterns.hint": "Det sidste mønster, der matcher, vinder.",
  "settings.agents.patterns.add": "Tilføj mønster",
  "settings.agents.patterns.placeholder": "Mønster, f.eks. git push",
  "settings.agents.patterns.remove": "Fjern mønster",
  "settings.agents.patterns.moveUp": "Flyt mønster op",
  "settings.agents.patterns.moveDown": "Flyt mønster ned",
  "settings.agents.action.new": "Ny agent",
  "settings.agents.action.create": "Opret",
  "settings.agents.action.deleteConfirm": "Bekræft sletning",
  "settings.agents.new.name": "Navn",
  "settings.agents.new.name.hint":
    "Bogstaver, tal, punktummer og bindestreger. Brug / til at indlejre, f.eks. team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Placering",
  "settings.agents.new.scope.hint": "Projektagenter ligger i .opencode/agent og deles med arkivet",
  "settings.agents.toast.created.title": "{{agent}} oprettet",
