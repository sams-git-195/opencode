export const dict = {
  ...
  "command.settings.agents": "Chỉnh sửa tác nhân",
  "titlebar.agentRefresh.label": "Tệp tác nhân đã thay đổi. Tải lại cấu hình",
  "settings.section.project": "Dự án",
  "settings.agents.empty": "Không tìm thấy tệp tác nhân. Thêm một tệp markdown trong .opencode/agent để tạo tác nhân.",
  "settings.agents.scope.project": "Dự án",
  "settings.agents.scope.global": "Toàn cục",
  "settings.agents.tag.disabled": "Đã tắt",
  "settings.agents.section.permissions": "Quyền",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Kế thừa",
  "settings.agents.field.description.title": "Mô tả",
  "settings.agents.field.description.description": "Cho các tác nhân khác biết khi nào nên dùng tác nhân này",
  "settings.agents.field.description.placeholder": "Tác nhân này nên làm gì?",
  "settings.agents.field.mode.title": "Chế độ",
  "settings.agents.field.mode.description": "Tác nhân chạy như tác nhân chính, tác nhân phụ hay cả hai",
  "settings.agents.field.model.title": "Mô hình",
  "settings.agents.field.model.description": "Mô hình mà tác nhân này sử dụng",
  "settings.agents.field.temperature.title": "Nhiệt độ",
  "settings.agents.field.temperature.description": "Nhiệt độ lấy mẫu, từ 0 đến 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Ngưỡng lấy mẫu nucleus, từ 0 đến 1",
  "settings.agents.field.steps.title": "Số bước",
  "settings.agents.field.steps.description": "Số lần lặp công cụ tối đa trước khi buộc trả lời chỉ bằng văn bản",
  "settings.agents.field.hidden.title": "Ẩn",
  "settings.agents.field.hidden.description": "Ẩn tác nhân phụ này khỏi menu nhắc đến",
  "settings.agents.field.disable.title": "Đã tắt",
  "settings.agents.field.disable.description": "Xóa tác nhân này khỏi danh sách tác nhân",
  "settings.agents.field.prompt.placeholder": "Prompt hệ thống cho tác nhân này",
  "settings.agents.mode.all": "Tất cả",
  "settings.agents.mode.primary": "Chính",
  "settings.agents.mode.subagent": "Tác nhân phụ",
  "settings.agents.rule.inherit": "Kế thừa",
  "settings.agents.rule.allow": "Cho phép",
  "settings.agents.rule.ask": "Hỏi",
  "settings.agents.rule.deny": "Từ chối",
  "settings.agents.extraKeys": "Chỉ chỉnh sửa được trong tệp: {{keys}}",
  "settings.agents.toast.saved.title": "Đã lưu {{agent}}",
  "settings.agents.toast.saved.description": "Thay đổi áp dụng cho các phiên mới.",
  "settings.agents.rule.patterns": "Theo mẫu",
  "settings.agents.patterns.hint": "Mẫu khớp cuối cùng sẽ được áp dụng.",
  "settings.agents.patterns.add": "Thêm mẫu",
  "settings.agents.patterns.placeholder": "Mẫu, ví dụ git push",
  "settings.agents.patterns.remove": "Xóa mẫu",
  "settings.agents.patterns.moveUp": "Di chuyển mẫu lên",
  "settings.agents.patterns.moveDown": "Di chuyển mẫu xuống",
  "settings.agents.action.new": "Tác nhân mới",
  "settings.agents.action.create": "Tạo",
  "settings.agents.action.deleteConfirm": "Xác nhận xóa",
  "settings.agents.new.name": "Tên",
  "settings.agents.new.name.hint":
    "Chữ cái, chữ số, dấu chấm và dấu gạch ngang. Dùng / để lồng nhau, ví dụ team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Vị trí",
  "settings.agents.new.scope.hint": "Tác nhân của dự án nằm trong .opencode/agent và được chia sẻ cùng kho lưu trữ",
  "settings.agents.toast.created.title": "Đã tạo {{agent}}",
  "settings.agents.toast.deleted.title": "Đã xóa {{agent}}",
}
