export const dict = {
  ...
  "command.settings.agents": "Edit agen",
  "titlebar.agentRefresh.label": "Berkas agen berubah. Muat ulang konfigurasi",
  "settings.section.project": "Proyek",
  "settings.agents.empty":
    "Tidak ada berkas agen yang ditemukan. Tambahkan berkas markdown di .opencode/agent untuk membuatnya.",
  "settings.agents.scope.project": "Proyek",
  "settings.agents.scope.global": "Global",
  "settings.agents.tag.disabled": "Dinonaktifkan",
  "settings.agents.section.permissions": "Izin",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Warisi",
  "settings.agents.field.description.title": "Deskripsi",
  "settings.agents.field.description.description": "Memberi tahu agen lain kapan harus menggunakan agen ini",
  "settings.agents.field.description.placeholder": "Apa yang harus dilakukan agen ini?",
  "settings.agents.field.mode.title": "Mode",
  "settings.agents.field.mode.description": "Apakah agen berjalan sebagai agen utama, subagen, atau keduanya",
  "settings.agents.field.model.title": "Model",
  "settings.agents.field.model.description": "Model yang digunakan agen ini",
  "settings.agents.field.temperature.title": "Temperatur",
  "settings.agents.field.temperature.description": "Temperatur sampling, antara 0 dan 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Ambang batas nucleus sampling, antara 0 dan 1",
  "settings.agents.field.steps.title": "Langkah",
  "settings.agents.field.steps.description": "Jumlah maksimum iterasi alat sebelum respons teks saja dipaksakan",
  "settings.agents.field.hidden.title": "Disembunyikan",
  "settings.agents.field.hidden.description": "Sembunyikan subagen ini dari menu sebutan",
  "settings.agents.field.disable.title": "Dinonaktifkan",
  "settings.agents.field.disable.description": "Hapus agen ini dari daftar agen",
  "settings.agents.field.prompt.placeholder": "Prompt sistem untuk agen ini",
  "settings.agents.mode.all": "Semua",
  "settings.agents.mode.primary": "Utama",
  "settings.agents.mode.subagent": "Subagen",
  "settings.agents.rule.inherit": "Warisi",
  "settings.agents.rule.allow": "Izinkan",
  "settings.agents.rule.ask": "Tanya",
  "settings.agents.rule.deny": "Tolak",
  "settings.agents.extraKeys": "Hanya dapat diedit di berkas: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} disimpan",
  "settings.agents.toast.saved.description": "Perubahan berlaku untuk sesi baru.",
  "settings.agents.rule.patterns": "Per pola",
  "settings.agents.patterns.hint": "Pola terakhir yang cocok yang berlaku.",
  "settings.agents.patterns.add": "Tambah pola",
  "settings.agents.patterns.placeholder": "Pola, misalnya git push",
  "settings.agents.patterns.remove": "Hapus pola",
  "settings.agents.patterns.moveUp": "Pindahkan pola ke atas",
  "settings.agents.patterns.moveDown": "Pindahkan pola ke bawah",
  "settings.agents.action.new": "Agen baru",
  "settings.agents.action.create": "Buat",
  "settings.agents.action.deleteConfirm": "Konfirmasi penghapusan",
  "settings.agents.new.name": "Nama",
  "settings.agents.new.name.hint":
    "Huruf, angka, titik, dan tanda hubung. Gunakan / untuk bersarang, misalnya team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Lokasi",
  "settings.agents.new.scope.hint": "Agen proyek berada di .opencode/agent dan dibagikan bersama repositori",
  "settings.agents.toast.created.title": "{{agent}} dibuat",
  "settings.agents.toast.deleted.title": "{{agent}} dihapus",
}
