...
export const dict = {
  ...
  "command.settings.agents": "Ajanları düzenle",
  "titlebar.agentRefresh.label": "Ajan dosyaları değişti. Yapılandırmayı yeniden yükle",
  "settings.section.project": "Proje",
  "settings.agents.empty":
    "Ajan dosyası bulunamadı. Bir ajan oluşturmak için .opencode/agent altına bir markdown dosyası ekleyin.",
  "settings.agents.scope.project": "Proje",
  "settings.agents.scope.global": "Genel",
  "settings.agents.tag.disabled": "Devre dışı",
  "settings.agents.section.permissions": "İzinler",
  "settings.agents.section.prompt": "İstem",
  "settings.agents.field.inherit": "Devral",
  "settings.agents.field.description.title": "Açıklama",
  "settings.agents.field.description.description": "Diğer ajanlara bu ajanın ne zaman kullanılacağını bildirir",
  "settings.agents.field.description.placeholder": "Bu ajan ne yapmalı?",
  "settings.agents.field.mode.title": "Mod",
  "settings.agents.field.mode.description":
    "Ajanın birincil ajan olarak mı, alt ajan olarak mı yoksa her ikisi olarak mı çalıştığı",
  "settings.agents.field.model.title": "Model",
  "settings.agents.field.model.description": "Bu ajanın çalıştığı model",
  "settings.agents.field.temperature.title": "Sıcaklık",
  "settings.agents.field.temperature.description": "0 ile 1 arasında örnekleme sıcaklığı",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "0 ile 1 arasında nucleus örnekleme eşiği",
  "settings.agents.field.steps.title": "Adımlar",
  "settings.agents.field.steps.description": "Yalnızca metin yanıtı zorlanmadan önceki en fazla araç yinelemesi sayısı",
  "settings.agents.field.hidden.title": "Gizli",
  "settings.agents.field.hidden.description": "Bu alt ajanı bahsetme menüsünde gizle",
  "settings.agents.field.disable.title": "Devre dışı",
  "settings.agents.field.disable.description": "Bu ajanı ajan listesinden kaldır",
  "settings.agents.field.prompt.placeholder": "Bu ajan için sistem istemi",
  "settings.agents.mode.all": "Tümü",
  "settings.agents.mode.primary": "Birincil",
  "settings.agents.mode.subagent": "Alt ajan",
  "settings.agents.rule.inherit": "Devral",
  "settings.agents.rule.allow": "İzin ver",
  "settings.agents.rule.ask": "Sor",
  "settings.agents.rule.deny": "Reddet",
  "settings.agents.extraKeys": "Yalnızca dosyada düzenlenebilir: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} kaydedildi",
  "settings.agents.toast.saved.description": "Değişiklikler yeni oturumlarda geçerli olur.",
  "settings.agents.rule.patterns": "Desene göre",
  "settings.agents.patterns.hint": "Eşleşen son desen geçerli olur.",
  "settings.agents.patterns.add": "Desen ekle",
  "settings.agents.patterns.placeholder": "Desen, örneğin git push",
  "settings.agents.patterns.remove": "Deseni kaldır",
  "settings.agents.patterns.moveUp": "Deseni yukarı taşı",
  "settings.agents.patterns.moveDown": "Deseni aşağı taşı",
  "settings.agents.action.new": "Yeni ajan",
  "settings.agents.action.create": "Oluştur",
  "settings.agents.action.deleteConfirm": "Silmeyi onayla",
  "settings.agents.new.name": "Ad",
  "settings.agents.new.name.hint":
    "Harf, rakam, nokta ve tire. İç içe yerleştirmek için / kullanın, örneğin team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Konum",
  "settings.agents.new.scope.hint": "Proje ajanları .opencode/agent içinde bulunur ve depoyla paylaşılır",
  "settings.agents.toast.created.title": "{{agent}} oluşturuldu",
