export const dict = {
  ...
  "command.settings.agents": "एजेंट संपादित करें",
  "titlebar.agentRefresh.label": "एजेंट फ़ाइलें बदल गई हैं। कॉन्फ़िगरेशन फिर से लोड करें",
  "settings.section.project": "प्रोजेक्ट",
  "settings.agents.empty":
    "कोई एजेंट फ़ाइल नहीं मिली। एजेंट बनाने के लिए .opencode/agent में एक markdown फ़ाइल जोड़ें।",
  "settings.agents.scope.project": "प्रोजेक्ट",
  "settings.agents.scope.global": "ग्लोबल",
  "settings.agents.tag.disabled": "अक्षम",
  "settings.agents.section.permissions": "अनुमतियाँ",
  "settings.agents.section.prompt": "प्रॉम्प्ट",
  "settings.agents.field.inherit": "इनहेरिट करें",
  "settings.agents.field.description.title": "विवरण",
  "settings.agents.field.description.description": "अन्य एजेंटों को बताता है कि इस एजेंट का उपयोग कब करना है",
  "settings.agents.field.description.placeholder": "यह एजेंट क्या करेगा?",
  "settings.agents.field.mode.title": "मोड",
  "settings.agents.field.mode.description": "एजेंट प्राथमिक एजेंट, सब-एजेंट या दोनों के रूप में चलेगा",
  "settings.agents.field.model.title": "मॉडल",
  "settings.agents.field.model.description": "वह मॉडल जिस पर यह एजेंट चलता है",
  "settings.agents.field.temperature.title": "तापमान",
  "settings.agents.field.temperature.description": "0 और 1 के बीच सैंपलिंग तापमान",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "0 और 1 के बीच न्यूक्लियस सैंपलिंग सीमा",
  "settings.agents.field.steps.title": "चरण",
  "settings.agents.field.steps.description": "केवल-पाठ प्रतिक्रिया लागू करने से पहले टूल के अधिकतम दोहराव",
  "settings.agents.field.hidden.title": "छिपा हुआ",
  "settings.agents.field.hidden.description": "इस सब-एजेंट को मेंशन मेन्यू से छिपाएँ",
  "settings.agents.field.disable.title": "अक्षम",
  "settings.agents.field.disable.description": "इस एजेंट को एजेंट सूची से हटाएँ",
  "settings.agents.field.prompt.placeholder": "इस एजेंट के लिए सिस्टम प्रॉम्प्ट",
  "settings.agents.mode.all": "सभी",
  "settings.agents.mode.primary": "प्राथमिक",
  "settings.agents.mode.subagent": "सब-एजेंट",
  "settings.agents.rule.inherit": "इनहेरिट करें",
  "settings.agents.rule.allow": "अनुमति दें",
  "settings.agents.rule.ask": "पूछें",
  "settings.agents.rule.deny": "अस्वीकार करें",
  "settings.agents.extraKeys": "केवल फ़ाइल में संपादन योग्य: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} सहेजा गया",
  "settings.agents.toast.saved.description": "परिवर्तन नए सत्रों पर लागू होते हैं।",
  "settings.agents.rule.patterns": "पैटर्न के अनुसार",
  "settings.agents.patterns.hint": "अंतिम मेल खाने वाला पैटर्न लागू होता है।",
  "settings.agents.patterns.add": "पैटर्न जोड़ें",
  "settings.agents.patterns.placeholder": "पैटर्न, जैसे git push",
  "settings.agents.patterns.remove": "पैटर्न हटाएँ",
  "settings.agents.patterns.moveUp": "पैटर्न ऊपर ले जाएँ",
  "settings.agents.patterns.moveDown": "पैटर्न नीचे ले जाएँ",
  "settings.agents.action.new": "नया एजेंट",
  "settings.agents.action.create": "बनाएँ",
  "settings.agents.action.deleteConfirm": "हटाने की पुष्टि करें",
  "settings.agents.new.name": "नाम",
  "settings.agents.new.name.hint": "अक्षर, अंक, बिंदु और हाइफ़न। नेस्ट करने के लिए / का उपयोग करें, जैसे team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "स्थान",
  "settings.agents.new.scope.hint": "प्रोजेक्ट एजेंट .opencode/agent में रहते हैं और रिपॉज़िटरी के साथ साझा होते हैं",
  "settings.agents.toast.created.title": "{{agent}} बनाया गया",
  "settings.agents.toast.deleted.title": "{{agent}} हटाया गया",
}
