export const dict = {
  ...
  "command.settings.agents": "Редагувати агентів",
  "titlebar.agentRefresh.label": "Файли агентів змінилися. Перезавантажити конфігурацію",
  "settings.section.project": "Проєкт",
  "settings.agents.empty": "Файлів агентів не знайдено. Додайте markdown-файл у .opencode/agent, щоб створити агента.",
  "settings.agents.scope.project": "Проєкт",
  "settings.agents.scope.global": "Глобально",
  "settings.agents.tag.disabled": "Вимкнено",
  "settings.agents.section.permissions": "Дозволи",
  "settings.agents.section.prompt": "Промпт",
  "settings.agents.field.inherit": "Успадкувати",
  "settings.agents.field.description.title": "Опис",
  "settings.agents.field.description.description": "Повідомляє іншим агентам, коли використовувати цього агента",
  "settings.agents.field.description.placeholder": "Що має робити цей агент?",
  "settings.agents.field.mode.title": "Режим",
  "settings.agents.field.mode.description": "Чи працює агент як основний агент, як субагент, чи як обидва",
  "settings.agents.field.model.title": "Модель",
  "settings.agents.field.model.description": "Модель, на якій працює цей агент",
  "settings.agents.field.temperature.title": "Температура",
  "settings.agents.field.temperature.description": "Температура семплювання від 0 до 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Поріг nucleus-семплювання від 0 до 1",
  "settings.agents.field.steps.title": "Кроки",
  "settings.agents.field.steps.description":
    "Максимальна кількість ітерацій інструментів до примусової текстової відповіді",
  "settings.agents.field.hidden.title": "Прихований",
  "settings.agents.field.hidden.description": "Приховати цього субагента з меню згадок",
  "settings.agents.field.disable.title": "Вимкнено",
  "settings.agents.field.disable.description": "Прибрати цього агента зі списку агентів",
  "settings.agents.field.prompt.placeholder": "Системний промпт для цього агента",
  "settings.agents.mode.all": "Усі",
  "settings.agents.mode.primary": "Основний",
  "settings.agents.mode.subagent": "Субагент",
  "settings.agents.rule.inherit": "Успадкувати",
  "settings.agents.rule.allow": "Дозволити",
  "settings.agents.rule.ask": "Запитувати",
  "settings.agents.rule.deny": "Заборонити",
  "settings.agents.extraKeys": "Редагується лише у файлі: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} збережено",
  "settings.agents.toast.saved.description": "Зміни застосовуються до нових сеансів.",
  "settings.agents.rule.patterns": "За шаблоном",
  "settings.agents.patterns.hint": "Перемагає останній відповідний шаблон.",
  "settings.agents.patterns.add": "Додати шаблон",
  "settings.agents.patterns.placeholder": "Шаблон, наприклад git push",
  "settings.agents.patterns.remove": "Видалити шаблон",
  "settings.agents.patterns.moveUp": "Перемістити шаблон вгору",
  "settings.agents.patterns.moveDown": "Перемістити шаблон вниз",
  "settings.agents.action.new": "Новий агент",
  "settings.agents.action.create": "Створити",
  "settings.agents.action.deleteConfirm": "Підтвердити видалення",
  "settings.agents.new.name": "Ім'я",
  "settings.agents.new.name.hint":
    "Літери, цифри, крапки й дефіси. Використовуйте / для вкладення, наприклад team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Розташування",
  "settings.agents.new.scope.hint": "Агенти проєкту зберігаються в .opencode/agent і поширюються разом зі сховищем",
  "settings.agents.toast.created.title": "{{agent}} створено",
  "settings.agents.toast.deleted.title": "{{agent}} видалено",
}
