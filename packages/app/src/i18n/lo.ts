export const dict = {
  ...
  // Untranslated: these fall back to the English source string. The runtime already resolves
  // missing keys to English, so these entries only satisfy the i18n parity check.
  "command.settings.agents": "Edit agents",
  "titlebar.agentRefresh.label": "Agent files changed. Reload configuration",
  "settings.section.project": "Project",
  "settings.agents.empty": "No agent files found. Add a markdown file under .opencode/agent to create one.",
  "settings.agents.scope.project": "Project",
  "settings.agents.scope.global": "Global",
  "settings.agents.tag.disabled": "Disabled",
  "settings.agents.section.permissions": "Permissions",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Inherit",
  "settings.agents.field.description.title": "Description",
  "settings.agents.field.description.description": "Tells other agents when to use this agent",
  "settings.agents.field.description.placeholder": "What should this agent do?",
  "settings.agents.field.mode.title": "Mode",
  "settings.agents.field.mode.description": "Whether the agent runs as a primary agent, a subagent, or both",
  "settings.agents.field.model.title": "Model",
  "settings.agents.field.model.description": "Model this agent runs on",
  "settings.agents.field.temperature.title": "Temperature",
  "settings.agents.field.temperature.description": "Sampling temperature, between 0 and 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Nucleus sampling threshold, between 0 and 1",
  "settings.agents.field.steps.title": "Steps",
  "settings.agents.field.steps.description": "Maximum tool iterations before a text-only response is forced",
  "settings.agents.field.hidden.title": "Hidden",
  "settings.agents.field.hidden.description": "Hide this subagent from the mention menu",
  "settings.agents.field.disable.title": "Disabled",
  "settings.agents.field.disable.description": "Remove this agent from the agent list",
  "settings.agents.field.prompt.placeholder": "System prompt for this agent",
  "settings.agents.mode.all": "All",
  "settings.agents.mode.primary": "Primary",
  "settings.agents.mode.subagent": "Subagent",
  "settings.agents.rule.inherit": "Inherit",
  "settings.agents.rule.allow": "Allow",
  "settings.agents.rule.ask": "Ask",
  "settings.agents.rule.deny": "Deny",
  "settings.agents.rule.patterns": "Per pattern",
  "settings.agents.patterns.hint": "The last matching pattern wins.",
  "settings.agents.patterns.add": "Add pattern",
  "settings.agents.patterns.placeholder": "Pattern, e.g. git push",
  "settings.agents.patterns.remove": "Remove pattern",
  "settings.agents.patterns.moveUp": "Move pattern up",
  "settings.agents.patterns.moveDown": "Move pattern down",
  "settings.agents.action.new": "New agent",
  "settings.agents.action.create": "Create",
  "settings.agents.action.deleteConfirm": "Confirm delete",
  "settings.agents.new.name": "Name",
  "settings.agents.new.name.hint": "Letters, numbers, dots and dashes. Use / to nest, e.g. team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Location",
  "settings.agents.new.scope.hint": "Project agents live in .opencode/agent and are shared with the repository",
  "settings.agents.toast.created.title": "Created {{agent}}",
  "settings.agents.toast.deleted.title": "Deleted {{agent}}",
  "settings.agents.extraKeys": "Only editable in the file: {{keys}}",
  "settings.agents.toast.saved.title": "Saved {{agent}}",
  "settings.agents.toast.saved.description": "Changes apply to new sessions.",
}
