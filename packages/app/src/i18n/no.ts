...
export const dict = {
  ...
  "command.settings.agents": "Rediger agenter",
  "titlebar.agentRefresh.label": "Agentfilene er endret. Last inn konfigurasjonen på nytt",
  "settings.section.project": "Prosjekt",
  "settings.agents.empty": "Ingen agentfiler funnet. Legg til en markdown-fil under .opencode/agent for å opprette en.",
  "settings.agents.scope.project": "Prosjekt",
  "settings.agents.scope.global": "Global",
  "settings.agents.tag.disabled": "Deaktivert",
  "settings.agents.section.permissions": "Tillatelser",
  "settings.agents.section.prompt": "Prompt",
  "settings.agents.field.inherit": "Arv",
  "settings.agents.field.description.title": "Beskrivelse",
  "settings.agents.field.description.description": "Forteller andre agenter når denne agenten skal brukes",
  "settings.agents.field.description.placeholder": "Hva skal denne agenten gjøre?",
  "settings.agents.field.mode.title": "Modus",
  "settings.agents.field.mode.description": "Om agenten kjører som primæragent, som underagent eller begge deler",
  "settings.agents.field.model.title": "Modell",
  "settings.agents.field.model.description": "Modellen denne agenten kjører på",
  "settings.agents.field.temperature.title": "Temperatur",
  "settings.agents.field.temperature.description": "Samplingstemperatur mellom 0 og 1",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "Terskel for nucleus-sampling mellom 0 og 1",
  "settings.agents.field.steps.title": "Trinn",
  "settings.agents.field.steps.description": "Maksimalt antall verktøykjøringer før et rent tekstsvar tvinges fram",
  "settings.agents.field.hidden.title": "Skjult",
  "settings.agents.field.hidden.description": "Skjul denne underagenten i omtalemenyen",
  "settings.agents.field.disable.title": "Deaktivert",
  "settings.agents.field.disable.description": "Fjern denne agenten fra agentlisten",
  "settings.agents.field.prompt.placeholder": "Systemprompt for denne agenten",
  "settings.agents.mode.all": "Alle",
  "settings.agents.mode.primary": "Primær",
  "settings.agents.mode.subagent": "Underagent",
  "settings.agents.rule.inherit": "Arv",
  "settings.agents.rule.allow": "Tillat",
  "settings.agents.rule.ask": "Spør",
  "settings.agents.rule.deny": "Avslå",
  "settings.agents.extraKeys": "Kan bare redigeres i filen: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} lagret",
  "settings.agents.toast.saved.description": "Endringene gjelder for nye økter.",
  "settings.agents.rule.patterns": "Per mønster",
  "settings.agents.patterns.hint": "Det siste mønsteret som treffer, vinner.",
  "settings.agents.patterns.add": "Legg til mønster",
  "settings.agents.patterns.placeholder": "Mønster, for eksempel git push",
  "settings.agents.patterns.remove": "Fjern mønster",
  "settings.agents.patterns.moveUp": "Flytt mønsteret opp",
  "settings.agents.patterns.moveDown": "Flytt mønsteret ned",
  "settings.agents.action.new": "Ny agent",
  "settings.agents.action.create": "Opprett",
  "settings.agents.action.deleteConfirm": "Bekreft sletting",
  "settings.agents.new.name": "Navn",
  "settings.agents.new.name.hint":
    "Bokstaver, tall, punktum og bindestrek. Bruk / for å neste, for eksempel team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "Plassering",
  "settings.agents.new.scope.hint": "Prosjektagenter ligger i .opencode/agent og deles med repositoriet",
  "settings.agents.toast.created.title": "{{agent}} opprettet",
  "settings.agents.toast.deleted.title": "{{agent}} slettet",
