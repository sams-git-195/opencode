export const dict = {
  ...
  "command.settings.agents": "ایجنٹاں وچ تبدیلی کرو",
  "titlebar.agentRefresh.label": "ایجنٹ فائلاں بدل گئیاں نيں۔ ترتیبات دوبارہ لوڈ کرو",
  "settings.section.project": "پروجیکٹ",
  "settings.agents.empty": "کوئی ایجنٹ فائل نہیں لبھی۔ ایجنٹ بݨاؤݨ لئی ‎.opencode/agent وچ اک markdown فائل شامل کرو۔",
  "settings.agents.scope.project": "پروجیکٹ",
  "settings.agents.scope.global": "عالمی",
  "settings.agents.tag.disabled": "غیر فعال",
  "settings.agents.section.permissions": "اجازتاں",
  "settings.agents.section.prompt": "پرامپٹ",
  "settings.agents.field.inherit": "وراثت وچ لؤ",
  "settings.agents.field.description.title": "تفصیل",
  "settings.agents.field.description.description": "دوجے ایجنٹاں نوں دسدا اے کہ ایس ایجنٹ نوں کدوں ورتݨا اے",
  "settings.agents.field.description.placeholder": "ایہ ایجنٹ کیہ کرے؟",
  "settings.agents.field.mode.title": "موڈ",
  "settings.agents.field.mode.description": "ایجنٹ بنیادی ایجنٹ، ذیلی ایجنٹ یا دوواں طور تے چلے گا",
  "settings.agents.field.model.title": "ماڈل",
  "settings.agents.field.model.description": "اوہ ماڈل جیدے تے ایہ ایجنٹ چلدا اے",
  "settings.agents.field.temperature.title": "ٹمپریچر",
  "settings.agents.field.temperature.description": "سیمپلنگ ٹمپریچر، 0 تے 1 وچکار",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "نیوکلیس سیمپلنگ دی حد، 0 تے 1 وچکار",
  "settings.agents.field.steps.title": "مرحلے",
  "settings.agents.field.steps.description": "نِرا متن والا جواب لاگو کرن توں پہلاں ٹولاں دی ودھ توں ودھ دُہرائی",
  "settings.agents.field.hidden.title": "لُکیا ہویا",
  "settings.agents.field.hidden.description": "ایس ذیلی ایجنٹ نوں مینشن مینو توں لُکاؤ",
  "settings.agents.field.disable.title": "غیر فعال",
  "settings.agents.field.disable.description": "ایس ایجنٹ نوں ایجنٹ لسٹ توں ہٹاؤ",
  "settings.agents.field.prompt.placeholder": "ایس ایجنٹ لئی سسٹم پرامپٹ",
  "settings.agents.mode.all": "سارے",
  "settings.agents.mode.primary": "بنیادی",
  "settings.agents.mode.subagent": "ذیلی ایجنٹ",
  "settings.agents.rule.inherit": "وراثت وچ لؤ",
  "settings.agents.rule.allow": "اجازت دیو",
  "settings.agents.rule.ask": "پُچھو",
  "settings.agents.rule.deny": "منع کرو",
  "settings.agents.extraKeys": "نِری فائل وچ تبدیلی ہو سکدی اے: {{keys}}",
  "settings.agents.toast.saved.title": "{{agent}} محفوظ ہو گیا",
  "settings.agents.toast.saved.description": "تبدیلیاں نویں سیشناں تے لاگو ہوندیاں نيں۔",
  "settings.agents.rule.patterns": "پیٹرن مطابق",
  "settings.agents.patterns.hint": "آخری مِلدا پیٹرن لاگو ہوندا اے۔",
  "settings.agents.patterns.add": "پیٹرن شامل کرو",
  "settings.agents.patterns.placeholder": "پیٹرن، مثلاً git push",
  "settings.agents.patterns.remove": "پیٹرن ہٹاؤ",
  "settings.agents.patterns.moveUp": "پیٹرن اُتے لے جاؤ",
  "settings.agents.patterns.moveDown": "پیٹرن تھلے لے جاؤ",
  "settings.agents.action.new": "نواں ایجنٹ",
  "settings.agents.action.create": "بݨاؤ",
  "settings.agents.action.deleteConfirm": "مٹاؤݨ دی تصدیق کرو",
  "settings.agents.new.name": "ناں",
  "settings.agents.new.name.hint": "حرف، عدد، نقطے تے ڈیش۔ نیسٹ کرن لئی / ورتو، مثلاً team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "تھاں",
  "settings.agents.new.scope.hint": "پروجیکٹ ایجنٹ ‎.opencode/agent وچ ہوندے نيں تے ریپازٹری نال شیئر ہوندے نيں",
  "settings.agents.toast.created.title": "{{agent}} بݨ گیا",
  "settings.agents.toast.deleted.title": "{{agent}} مٹا دِتا گیا",
}
