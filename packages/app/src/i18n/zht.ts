...
export const dict = {
  ...
  "command.settings.agents": "編輯代理程式",
  "titlebar.agentRefresh.label": "代理程式檔案已變更。重新載入設定",
  "settings.section.project": "專案",
  "settings.agents.empty": "找不到代理程式檔案。在 .opencode/agent 下新增 markdown 檔案即可建立。",
  "settings.agents.scope.project": "專案",
  "settings.agents.scope.global": "全域",
  "settings.agents.tag.disabled": "已停用",
  "settings.agents.section.permissions": "權限",
  "settings.agents.section.prompt": "提示詞",
  "settings.agents.field.inherit": "繼承",
  "settings.agents.field.description.title": "描述",
  "settings.agents.field.description.description": "告訴其他代理程式何時使用此代理程式",
  "settings.agents.field.description.placeholder": "這個代理程式該做什麼？",
  "settings.agents.field.mode.title": "模式",
  "settings.agents.field.mode.description": "此代理程式要以主要代理程式、子代理程式或兩者執行",
  "settings.agents.field.model.title": "模型",
  "settings.agents.field.model.description": "此代理程式使用的模型",
  "settings.agents.field.temperature.title": "溫度",
  "settings.agents.field.temperature.description": "取樣溫度，介於 0 與 1 之間",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "核心取樣閾值，介於 0 與 1 之間",
  "settings.agents.field.steps.title": "步驟",
  "settings.agents.field.steps.description": "強制產生純文字回應前的最大工具迭代次數",
  "settings.agents.field.hidden.title": "隱藏",
  "settings.agents.field.hidden.description": "在提及選單中隱藏此子代理程式",
  "settings.agents.field.disable.title": "已停用",
  "settings.agents.field.disable.description": "將此代理程式從代理程式清單中移除",
  "settings.agents.field.prompt.placeholder": "此代理程式的系統提示詞",
  "settings.agents.mode.all": "全部",
  "settings.agents.mode.primary": "主要",
  "settings.agents.mode.subagent": "子代理程式",
  "settings.agents.rule.inherit": "繼承",
  "settings.agents.rule.allow": "允許",
  "settings.agents.rule.ask": "詢問",
  "settings.agents.rule.deny": "拒絕",
  "settings.agents.extraKeys": "僅可在檔案中編輯：{{keys}}",
  "settings.agents.toast.saved.title": "已儲存 {{agent}}",
  "settings.agents.toast.saved.description": "變更會套用至新工作階段。",
  "settings.agents.rule.patterns": "依樣式",
  "settings.agents.patterns.hint": "最後符合的樣式優先。",
  "settings.agents.patterns.add": "新增樣式",
  "settings.agents.patterns.placeholder": "樣式，例如 git push",
  "settings.agents.patterns.remove": "移除樣式",
  "settings.agents.patterns.moveUp": "將樣式上移",
  "settings.agents.patterns.moveDown": "將樣式下移",
  "settings.agents.action.new": "新增代理程式",
  "settings.agents.action.create": "建立",
  "settings.agents.action.deleteConfirm": "確認刪除",
  "settings.agents.new.name": "名稱",
  "settings.agents.new.name.hint": "可使用英文字母、數字、句點與連字號。用 / 分層，例如 team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "位置",
  "settings.agents.new.scope.hint": "專案代理程式位於 .opencode/agent，並隨存放庫共用",
  "settings.agents.toast.created.title": "已建立 {{agent}}",
  "settings.agents.toast.deleted.title": "已刪除 {{agent}}",
