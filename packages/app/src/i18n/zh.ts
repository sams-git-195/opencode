...
export const dict = {
  ...
  "command.settings.agents": "编辑智能体",
  "titlebar.agentRefresh.label": "智能体文件已更改。重新加载配置",
  "settings.section.project": "项目",
  "settings.agents.empty": "未找到智能体文件。在 .opencode/agent 下添加一个 markdown 文件即可创建。",
  "settings.agents.scope.project": "项目",
  "settings.agents.scope.global": "全局",
  "settings.agents.tag.disabled": "已禁用",
  "settings.agents.section.permissions": "权限",
  "settings.agents.section.prompt": "提示词",
  "settings.agents.field.inherit": "继承",
  "settings.agents.field.description.title": "描述",
  "settings.agents.field.description.description": "告诉其他智能体何时使用该智能体",
  "settings.agents.field.description.placeholder": "该智能体应该做什么？",
  "settings.agents.field.mode.title": "模式",
  "settings.agents.field.mode.description": "该智能体作为主智能体、子智能体还是两者运行",
  "settings.agents.field.model.title": "模型",
  "settings.agents.field.model.description": "该智能体使用的模型",
  "settings.agents.field.temperature.title": "温度",
  "settings.agents.field.temperature.description": "采样温度，介于 0 和 1 之间",
  "settings.agents.field.topP.title": "Top P",
  "settings.agents.field.topP.description": "核采样阈值，介于 0 和 1 之间",
  "settings.agents.field.steps.title": "步数",
  "settings.agents.field.steps.description": "强制返回纯文本响应前的最大工具迭代次数",
  "settings.agents.field.hidden.title": "隐藏",
  "settings.agents.field.hidden.description": "在提及菜单中隐藏该子智能体",
  "settings.agents.field.disable.title": "已禁用",
  "settings.agents.field.disable.description": "从智能体列表中移除该智能体",
  "settings.agents.field.prompt.placeholder": "该智能体的系统提示词",
  "settings.agents.mode.all": "全部",
  "settings.agents.mode.primary": "主智能体",
  "settings.agents.mode.subagent": "子智能体",
  "settings.agents.rule.inherit": "继承",
  "settings.agents.rule.allow": "允许",
  "settings.agents.rule.ask": "询问",
  "settings.agents.rule.deny": "拒绝",
  "settings.agents.extraKeys": "仅可在文件中编辑：{{keys}}",
  "settings.agents.toast.saved.title": "已保存 {{agent}}",
  "settings.agents.toast.saved.description": "更改将应用于新会话。",
  "settings.agents.rule.patterns": "按模式",
  "settings.agents.patterns.hint": "最后匹配的模式生效。",
  "settings.agents.patterns.add": "添加模式",
  "settings.agents.patterns.placeholder": "模式，例如 git push",
  "settings.agents.patterns.remove": "移除模式",
  "settings.agents.patterns.moveUp": "上移模式",
  "settings.agents.patterns.moveDown": "下移模式",
  "settings.agents.action.new": "新建智能体",
  "settings.agents.action.create": "创建",
  "settings.agents.action.deleteConfirm": "确认删除",
  "settings.agents.new.name": "名称",
  "settings.agents.new.name.hint": "可使用字母、数字、点和连字符。用 / 分层，例如 team/reviewer",
  "settings.agents.new.name.placeholder": "reviewer",
  "settings.agents.new.scope": "位置",
  "settings.agents.new.scope.hint": "项目智能体位于 .opencode/agent，并随仓库共享",
  "settings.agents.toast.created.title": "已创建 {{agent}}",
  "settings.agents.toast.deleted.title": "已删除 {{agent}}",
